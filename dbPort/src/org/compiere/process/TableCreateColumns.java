...
{
	/** Entity Type			*/
	private String	p_EntityType = "EXME";	//	ENTITYTYPE_Customization
	/** Table				*/
	...
	private void addTableColumn (ResultSet rs, MTable table) throws Exception
	{
		...
		while (rs.next ())
		{
			...
			else if (columnName.equalsIgnoreCase ("EXME_Employment_ID"))
				column.setAD_Reference_ID (DisplayType.Employment);
			// Product Attribute
            ...
            //expert : gisela lee : Date Size=10
			...
			//Expert: Lama (defautl selection columns)
			...
			if (column.save ())
			{
				...
				addLog(CLogger.retrieveError().getValue());
			}
		}	//	while columns
