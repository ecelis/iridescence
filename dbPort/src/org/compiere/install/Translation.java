 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: Translation.java,v 1.1 2006/04/21 17:43:15 jjanke Exp $
 */
public class Translation
{
	...
	public static void main (String[] args)
	{
		if (args.length != 3)
		{
			...
			System.out.println("ejemplo: java Translation /Compiere2/data/de_DE de_DE import");
			System.out.println("ejemplo: java Translation /Compiere2/data/fr_FR fr_FR export");
			/* EXPERT: mrojas */
			System.exit(1);
		}
		//
