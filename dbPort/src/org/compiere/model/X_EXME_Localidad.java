...
/** Generated Model for EXME_Localidad
 *  @author Generated Class 
 *  @version Release 1.2 - $Id$ */
public class X_EXME_Localidad extends PO implements I_EXME_Localidad, I_Persistent 
{
    ...
    public X_EXME_Localidad (Properties ctx, int EXME_Localidad_ID, String trxName)
    {
      super (ctx, EXME_Localidad_ID, trxName);
      /** if (EXME_Localidad_ID == 0)
        {
			setEXME_Localidad_ID (0);
    ...
    /** Load Constructor */
    public X_EXME_Localidad (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_Localidad[")
	...
	public void setEXME_Localidad_ID (int EXME_Localidad_ID)
	{
		if (EXME_Localidad_ID < 1)
			 throw new IllegalArgumentException ("EXME_Localidad_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_EXME_Localidad_ID, Integer.valueOf(EXME_Localidad_ID));
	}
