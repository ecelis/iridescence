...
// N
	...
	/** ChatEntryType AD_Reference_ID=1200268 */
	public static final int CHATENTRYTYPE_AD_Reference_ID=1200268;
	/** Wiki = W */
	...
	public void setChatEntryType (String ChatEntryType)
	{
		...
		if (ChatEntryType.equals("W") || ChatEntryType.equals("N") || ChatEntryType.equals("F")); else throw new IllegalArgumentException ("ChatEntryType Invalid value - " + ChatEntryType + " - Reference_ID=1200268 - W - N - F");		set_Value (COLUMNNAME_ChatEntryType, ChatEntryType);
	}
	...
	/** ModeratorStatus AD_Reference_ID=1200266 */
	public static final int MODERATORSTATUS_AD_Reference_ID=1200266;
	/** Not Displayed = N */
	...
	public void setModeratorStatus (String ModeratorStatus)
	{
		...
		if (ModeratorStatus == null || ModeratorStatus.equals("N") || ModeratorStatus.equals("P") || ModeratorStatus.equals("R") || ModeratorStatus.equals("S")); else throw new IllegalArgumentException ("ModeratorStatus Invalid value - " + ModeratorStatus + " - Reference_ID=1200266 - N - P - R - S");		set_Value (COLUMNNAME_ModeratorStatus, ModeratorStatus);
	}
