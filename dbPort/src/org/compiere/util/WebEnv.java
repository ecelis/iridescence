 ...
 *
 *  @author Jorg Janke
 *  @version $Id: WebEnv.java,v 1.5 2006/08/23 00:54:39 mrojas Exp $
 */
public class WebEnv
{
	/** Add HTML Debug Info                     */
	 ...
	 */
	public static final String   	DIR_BASE    = "/" + Compiere.CONTEXT_NAME;
	...
	/** Timeout - 120  Minutes                    */
	public static final int         TIMEOUT     = 60; //180*60
...
//			"ServerInfo: " + context.getServerInfo(), null);
	...
	public static void dump (HttpServletRequest request)
	{
		...
		while (e.hasMoreElements())
		{
			...
			first = false;
			String key = (String)e.nextElement();
			String value = WebUtilParent.getParameter (request, key);
			log.finer("  - " + key + " = " + value);
		}
		first = true;
		/** Attributes	*/
		...
		HttpServletResponse response, HttpServlet servlet)
	{
		...
		while (e.hasMoreElements())
		{
			...
			String para = WebUtilParent.getParameter (request, name);
			table.addElement(new tr().addElement(new td().addElement(name))
	...
	/*
	 * Expert: Hassan - Inicia - Obtenemos el Archivo de Propiedades Path.properties 
	 */
	
	public static String JASPERFilePath = "JASPERFilePath";
	public static String ChartFilePath = "ChartFilePath";
	public static String IMGFilePath = "IMGFilePath";
	public static String PDFFilePath = "PDFFilePath";
	public static String NoPaginas = "NoPaginas";
	public static String NoRegistros = "NoRegistros";
	public static String IMGPacientesFilePath = "IMGPacientesFilePath";

	public static String DVisionFilePath = "DVisionFilePath";
	public static String SecSaludEndPoint = "SecSaludEndPoint";
	public static String RisToMedsysRepository = "RisToMedsysRepository";
	public static String MedsysToRisRepository = "MedsysToRisRepository";


	/**
	 * Returns the Path properties
	 * @return
	 */
	public static Properties getXPT_Properties(){
	    return getProperties("Paths.properties");
	}
	/**
	...
	/**
	 * Returns the CompiereEnv properties	
	 * @author Lorena Lama
	 * @return
	 */
	public static Properties getEnv_Properties() {
		return getProperties("CompiereEnv.properties");
	}

	/**
	 * Returns an specific properties
	 * @author Lorena Lama
	 * @param propPath
	 * @return
	 */
	public static Properties getProperties(String propPath){
		...
		if (env != null) {
			...
			try {
				properties.load(new FileInputStream(env + File.separator + propPath));
			} catch (IOException e) {
				log.log(Level.SEVERE, "getProperties: "+propPath, e);
			}
		}
	    return properties;
	}
