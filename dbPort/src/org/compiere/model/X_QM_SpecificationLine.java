...
public class X_QM_SpecificationLine extends PO implements I_QM_SpecificationLine, I_Persistent 
{
	...
	public org.compiere.model.I_QM_Specification getQM_Specification() throws RuntimeException 
    {
        Class<?> clazz = MTable.getClass(org.compiere.model.I_QM_Specification.Table_Name);
        org.compiere.model.I_QM_Specification result = null;
        try	{
	        Constructor<?> constructor = null;
	    	constructor = clazz.getDeclaredConstructor(new Class[]{Properties.class, int.class, String.class});
    	    result = (org.compiere.model.I_QM_Specification)constructor.newInstance(new Object[] {getCtx(), new Integer(getQM_Specification_ID()), get_TrxName()});
        } catch (Exception e) {
	        log.log(Level.SEVERE, "(id) - Table=" + Table_Name + ",Class=" + clazz, e);
	        log.saveError("Error", "Table=" + Table_Name + ",Class=" + clazz);
           throw new RuntimeException( e );
