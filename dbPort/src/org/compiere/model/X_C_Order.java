...
// 5
	...
	/** Get Date Completed.
		@return Date the document was Completed.
	  */
	...
	/** Set Global Discount.
		@param DescuentoGlobal Global Discount	  */
	public void setDescuentoGlobal (BigDecimal DescuentoGlobal)
	{
		set_Value (COLUMNNAME_DescuentoGlobal, DescuentoGlobal);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_DescuentoGlobal);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Set isBeingUsedInOut.
		@param isBeingUsedInOut isBeingUsedInOut	  */
	public void setisBeingUsedInOut (boolean isBeingUsedInOut)
	{
		set_Value (COLUMNNAME_isBeingUsedInOut, Boolean.valueOf(isBeingUsedInOut));
	}

	/** Get isBeingUsedInOut.
		@return isBeingUsedInOut	  */
	public boolean isBeingUsedInOut () 
	{
		Object oo = get_Value(COLUMNNAME_isBeingUsedInOut);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set Consigna.
		@param isConsigna Consigna	  */
	public void setisConsigna (boolean isConsigna)
	{
		set_Value (COLUMNNAME_isConsigna, Boolean.valueOf(isConsigna));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_isConsigna);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
