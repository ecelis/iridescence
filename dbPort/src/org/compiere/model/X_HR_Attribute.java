...
public class X_HR_Attribute extends PO implements I_HR_Attribute, I_Persistent 
{
	...
	public org.compiere.model.I_HR_Employee getHR_Employee() throws RuntimeException 
    {
        Class<?> clazz = MTable.getClass(org.compiere.model.I_HR_Employee.Table_Name);
        org.compiere.model.I_HR_Employee result = null;
        try	{
	        Constructor<?> constructor = null;
	    	constructor = clazz.getDeclaredConstructor(new Class[]{Properties.class, int.class, String.class});
    	    result = (org.compiere.model.I_HR_Employee)constructor.newInstance(new Object[] {getCtx(), new Integer(getHR_Employee_ID()), get_TrxName()});
        } catch (Exception e) {
	        log.log(Level.SEVERE, "(id) - Table=" + Table_Name + ",Class=" + clazz, e);
	        log.saveError("Error", "Table=" + Table_Name + ",Class=" + clazz);
           throw new RuntimeException( e );
	...
	public org.compiere.model.I_HR_Payroll getHR_Payroll() throws RuntimeException 
    {
        Class<?> clazz = MTable.getClass(org.compiere.model.I_HR_Payroll.Table_Name);
        org.compiere.model.I_HR_Payroll result = null;
        try	{
	        Constructor<?> constructor = null;
	    	constructor = clazz.getDeclaredConstructor(new Class[]{Properties.class, int.class, String.class});
    	    result = (org.compiere.model.I_HR_Payroll)constructor.newInstance(new Object[] {getCtx(), new Integer(getHR_Payroll_ID()), get_TrxName()});
        } catch (Exception e) {
	        log.log(Level.SEVERE, "(id) - Table=" + Table_Name + ",Class=" + clazz, e);
	        log.saveError("Error", "Table=" + Table_Name + ",Class=" + clazz);
           throw new RuntimeException( e );
