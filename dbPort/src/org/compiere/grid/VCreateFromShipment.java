...
public class VCreateFromShipment extends VCreateFrom implements VetoableChangeListener
{
	...
	protected boolean dynInit() throws Exception
	{
        ...
        /*INICIO DE CAMBIOS EXPERT - ASAEL SEPULVEDA
         * Para mostrar el localizar por default al entrar a "crear desde"
         **/
		...
		/*Obtener el id del almacen seleccionado de la ventana (recepci�n de material)*/
		int wid = Integer.parseInt(Env.getContext(Env.getCtx(), p_WindowNo, "M_Warehouse_ID", true));
        MLocatorLookup locator = new MLocatorLookup(Env.getCtx(), p_WindowNo, wid);
        locatorField = new VLocator ("M_Locator_ID", true, false, true, locator, p_WindowNo);

        locator.setOnly_Warehouse_ID(wid);
		/*Obtener el localizador por defecto asignado al almacen seleccionado*/
		MLocator defaultLocator = MLocator.getDefault(Env.getCtx(), MLocator.getLocatorID(Env.getCtx(), wid, null));
		/*Asignar el valor al campo del localizador si es que existe el default */
        if(defaultLocator!=null)
            locatorField.setValue(defaultLocator.getM_Locator_ID());
		
		/*FIN DE CAMBIOS EXPERT - ASAEL SEPULVEDA
		* * Para mostrar el localizar por default al entrar a "crear desde"
		**/
