...
// @AD_User_ID@
	...
	public void setConfidentialType (String ConfidentialType)
	{
		...
		if (ConfidentialType == null || ConfidentialType.equals("A") || ConfidentialType.equals("C") || ConfidentialType.equals("I") || ConfidentialType.equals("P")); else throw new IllegalArgumentException ("ConfidentialType Invalid value - " + ConfidentialType + " - Reference_ID=340 - A - C - I - P");		set_Value (COLUMNNAME_ConfidentialType, ConfidentialType);
	}
	...
	{
		set_Value (COLUMNNAME_Initials, Initials);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_Initials);
	}
	...
	/** NoteType AD_Reference_ID=1200559 */
	public static final int NOTETYPE_AD_Reference_ID=1200559;
	/** DemographicUpdate = DU */
	public static final String NOTETYPE_DemographicUpdate = "DU";
	/** FinancialArrangments = FA */
	public static final String NOTETYPE_FinancialArrangments = "FA";
	/** GeneralNote = GN */
	public static final String NOTETYPE_GeneralNote = "GN";
	/** InsuranceUpdate = IU */
	public static final String NOTETYPE_InsuranceUpdate = "IU";
	/** FollowUp = FU */
	public static final String NOTETYPE_FollowUp = "FU";
	/** PatientCall = PC */
	public static final String NOTETYPE_PatientCall = "PC";
	/** RegistrationNote = RN */
	public static final String NOTETYPE_RegistrationNote = "RN";
	/** Set Note Type.
		@param NoteType Note Type	  */
	public void setNoteType (String NoteType)
	{

		if (NoteType == null || NoteType.equals("DU") || NoteType.equals("FA") || NoteType.equals("GN") || NoteType.equals("IU") || NoteType.equals("FU") || NoteType.equals("PC") || NoteType.equals("RN")); else throw new IllegalArgumentException ("NoteType Invalid value - " + NoteType + " - Reference_ID=1200559 - DU - FA - GN - IU - FU - PC - RN");		set_Value (COLUMNNAME_NoteType, NoteType);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_NoteType);
	}
