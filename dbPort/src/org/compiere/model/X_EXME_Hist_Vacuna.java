...
/** Generated Model for EXME_Hist_Vacuna
 *  @author Generated Class 
 *  @version Version @VERSION@ - $Id$ */
public class X_EXME_Hist_Vacuna extends PO implements I_EXME_Hist_Vacuna, I_Persistent 
{
    ...
    public X_EXME_Hist_Vacuna (Properties ctx, int EXME_Hist_Vacuna_ID, String trxName)
    {
      super (ctx, EXME_Hist_Vacuna_ID, trxName);
      /** if (EXME_Hist_Vacuna_ID == 0)
        {
			setCantidad (Env.ZERO);
			setEdad (Env.ZERO);
			setEXME_Hist_Vacuna_ID (0);
    ...
    /** Load Constructor */
    public X_EXME_Hist_Vacuna (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_Hist_Vacuna[")
	...
	public void setEXME_Hist_Vacuna_ID (int EXME_Hist_Vacuna_ID)
	{
		if (EXME_Hist_Vacuna_ID < 1)
			 throw new IllegalArgumentException ("EXME_Hist_Vacuna_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_EXME_Hist_Vacuna_ID, Integer.valueOf(EXME_Hist_Vacuna_ID));
	}
	...
	/** MotivoRechazo AD_Reference_ID=1200381 */
	public static final int MOTIVORECHAZO_AD_Reference_ID=1200381;
	/** Immunity = 001 */
	public static final String MOTIVORECHAZO_Immunity = "001";
	/** Medical Precaution = 002 */
	public static final String MOTIVORECHAZO_MedicalPrecaution = "002";
	/** Out of Stock = 003 */
	public static final String MOTIVORECHAZO_OutOfStock = "003";
	/** Patient Objection = 004 */
	public static final String MOTIVORECHAZO_PatientObjection = "004";
	/** Philosophical Objection = 005 */
	public static final String MOTIVORECHAZO_PhilosophicalObjection = "005";
	/** Religious Objection = 006 */
	public static final String MOTIVORECHAZO_ReligiousObjection = "006";
	/** Vaccine Efficacy Concerns = 007 */
	public static final String MOTIVORECHAZO_VaccineEfficacyConcerns = "007";
	/** Vaccine Safety Concerns = 008 */
	public static final String MOTIVORECHAZO_VaccineSafetyConcerns = "008";
	...
	public void setMotivoRechazo (String MotivoRechazo)
	{
		...
		if (MotivoRechazo == null || MotivoRechazo.equals("001") || MotivoRechazo.equals("002") || MotivoRechazo.equals("003") || MotivoRechazo.equals("004") || MotivoRechazo.equals("005") || MotivoRechazo.equals("006") || MotivoRechazo.equals("007") || MotivoRechazo.equals("008")); else throw new IllegalArgumentException ("MotivoRechazo Invalid value - " + MotivoRechazo + " - Reference_ID=1200381 - 001 - 002 - 003 - 004 - 005 - 006 - 007 - 008");		set_Value (COLUMNNAME_MotivoRechazo, MotivoRechazo);
	}
	...
	/** Site AD_Reference_ID=1200372 */
	public static final int SITE_AD_Reference_ID=1200372;
	/** Right Arm = RA */
	public static final String SITE_RightArm = "RA";
	/** Left Arm = LA */
	public static final String SITE_LeftArm = "LA";
	/** Right Thigh = RT */
	public static final String SITE_RightThigh = "RT";
	/** Left Thigh = LT */
	public static final String SITE_LeftThigh = "LT";
	/** Intranasal = IN */
	public static final String SITE_Intranasal = "IN";
	/** By Mouth = PO */
	public static final String SITE_ByMouth = "PO";
	/** Set Site.
		@param Site 
	...
	public void setSite (String Site)
	{
		...
		if (Site == null || Site.equals("RA") || Site.equals("LA") || Site.equals("RT") || Site.equals("LT") || Site.equals("IN") || Site.equals("PO")); else throw new IllegalArgumentException ("Site Invalid value - " + Site + " - Reference_ID=1200372 - RA - LA - RT - LT - IN - PO");		set_Value (COLUMNNAME_Site, Site);
	}
	...
	/** Source AD_Reference_ID=1200373 */
	public static final int SOURCE_AD_Reference_ID=1200373;
	/** Federally Supported = F */
	public static final String SOURCE_FederallySupported = "F";
	/** State Supported = S */
	public static final String SOURCE_StateSupported = "S";
	/** Supported by Private Insurance = P */
	public static final String SOURCE_SupportedByPrivateInsurance = "P";
	/** Set Source.
		@param Source 
	...
	public void setSource (String Source)
	{
		...
		if (Source == null || Source.equals("F") || Source.equals("S") || Source.equals("P")); else throw new IllegalArgumentException ("Source Invalid value - " + Source + " - Reference_ID=1200373 - F - S - P");		set_Value (COLUMNNAME_Source, Source);
	}
