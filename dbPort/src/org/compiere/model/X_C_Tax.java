...
// B
	...
	/** Sales by extension Tax = S */
	public static final String SOPOTYPE_SalesByExtensionTax = "S";
	/** Purchase and Direct sales Tax = P */
	public static final String SOPOTYPE_PurchaseAndDirectSalesTax = "P";
	/** Set SO/PO Type.
		@param SOPOType 
	...
	{
		set_Value (COLUMNNAME_WithholdingTax, Boolean.valueOf(WithholdingTax));
	}

	/** Get WithholdingTax.
		@return If Withholding Tax
	  */
	public boolean isWithholdingTax () 
	{
		Object oo = get_Value(COLUMNNAME_WithholdingTax);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
