...
public class X_C_PaymentProcessor extends PO implements I_C_PaymentProcessor, I_Persistent 
{
	...
	/** Set Accept American Express Card.
		@param AcceptAMEX 
	...
	/** Get Accept American Express Card.
	...
	{
		return (String)get_ValueE(COLUMNNAME_ProxyPassword);
	}
	...
	/** Set Vendor.
		@param VendorID 
		Vendor for the Payment Processor
	  */
	...
	/** Get Vendor.
		@return Vendor for the Payment Processor
	  */
