...
// N
	...
	/** CardTransferType AD_Reference_ID=1200331 */
	public static final int CARDTRANSFERTYPE_AD_Reference_ID=1200331;
	/** Bank Account = B */
	...
	public void setCardTransferType (String CardTransferType)
	{
		...
		if (CardTransferType == null || CardTransferType.equals("B") || CardTransferType.equals("C")); else throw new IllegalArgumentException ("CardTransferType Invalid value - " + CardTransferType + " - Reference_ID=1200331 - B - C");		set_Value (COLUMNNAME_CardTransferType, CardTransferType);
	}
	...
	/** CashBookTransferType AD_Reference_ID=1200331 */
	public static final int CASHBOOKTRANSFERTYPE_AD_Reference_ID=1200331;
	/** Bank Account = B */
	...
	public void setCashBookTransferType (String CashBookTransferType)
	{
		...
		if (CashBookTransferType.equals("B") || CashBookTransferType.equals("C")); else throw new IllegalArgumentException ("CashBookTransferType Invalid value - " + CashBookTransferType + " - Reference_ID=1200331 - B - C");		set_Value (COLUMNNAME_CashBookTransferType, CashBookTransferType);
	}
	...
	/** CheckTransferType AD_Reference_ID=1200331 */
	public static final int CHECKTRANSFERTYPE_AD_Reference_ID=1200331;
	/** Bank Account = B */
	...
	public void setCheckTransferType (String CheckTransferType)
	{
		...
		if (CheckTransferType == null || CheckTransferType.equals("B") || CheckTransferType.equals("C")); else throw new IllegalArgumentException ("CheckTransferType Invalid value - " + CheckTransferType + " - Reference_ID=1200331 - B - C");		set_Value (COLUMNNAME_CheckTransferType, CheckTransferType);
	}
