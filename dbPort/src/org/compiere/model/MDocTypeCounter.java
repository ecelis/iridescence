...
public class MDocTypeCounter extends X_C_DocTypeCounter
{
	...
	public static String getCounterDocBaseType (String DocBaseType)
	{
		...
		//AP/AR Invoice //Expert. TTPR # Posteo Notas de Debito
		else if (MDocType.DOCBASETYPE_APDebitMemo.equals(DocBaseType))
			retValue = MDocType.DOCBASETYPE_ARDebitMemo;
		else if (MDocType.DOCBASETYPE_ARDebitMemo.equals(DocBaseType))
			retValue = MDocType.DOCBASETYPE_APDebitMemo;
	...
	public String validate()
	{
		...
		//	AP/AR Invoice//Expert. TTPR # Posteo Notas de Debito
		else if ((MDocType.DOCBASETYPE_APDebitMemo.equals(dtBT) && MDocType.DOCBASETYPE_ARDebitMemo.equals(c_dtBT))
			|| (MDocType.DOCBASETYPE_APDebitMemo.equals(c_dtBT) && MDocType.DOCBASETYPE_ARDebitMemo.equals(dtBT))) 
			setIsValid(true);
