...
// 5
    ...
    {
        Class<?> clazz = MTable.getClass(I_EXME_Buyer.Table_Name);
        I_EXME_Buyer result = null;
        try	{
	        Constructor<?> constructor = null;
	    	constructor = clazz.getDeclaredConstructor(new Class[]{Properties.class, int.class, String.class});
    	    result = (I_EXME_Buyer)constructor.newInstance(new Object[] {getCtx(), new Integer(getEXME_Buyer_ID()), get_TrxName()});
        } catch (Exception e) {
	        log.log(Level.SEVERE, "(id) - Table=" + Table_Name + ",Class=" + clazz, e);
	        log.saveError("Error", "Table=" + Table_Name + ",Class=" + clazz);
           throw new RuntimeException( e );
	...
	{
		if (EXME_Buyer_ID < 1) 
			set_Value (COLUMNNAME_EXME_Buyer_ID, null);
		else 
			set_Value (COLUMNNAME_EXME_Buyer_ID, Integer.valueOf(EXME_Buyer_ID));
	}
	...
	/** Set Show.
		@param IsMostrado Show	  */
	public void setIsMostrado (boolean IsMostrado)
	{
		set_Value (COLUMNNAME_IsMostrado, Boolean.valueOf(IsMostrado));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_IsMostrado);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** IsTransfered AD_Reference_ID=1200157 */
	public static final int ISTRANSFERED_AD_Reference_ID=1200157;
	/** Rejected Absolute = A */
	public static final String ISTRANSFERED_RejectedAbsolute = "A";
	/** Not Applicable = N */
	public static final String ISTRANSFERED_NotApplicable = "N";
	/** Pending Transfer = P */
	public static final String ISTRANSFERED_PendingTransfer = "P";
	/** Rejected = R */
	public static final String ISTRANSFERED_Rejected = "R";
	/** Transferred = Y */
	public static final String ISTRANSFERED_Transferred = "Y";
	/** Set Is Transfered.
		@param IsTransfered 
	...
	public void setIsTransfered (String IsTransfered)
	{
		...
		if (IsTransfered == null || IsTransfered.equals("A") || IsTransfered.equals("N") || IsTransfered.equals("P") || IsTransfered.equals("R") || IsTransfered.equals("Y")); else throw new IllegalArgumentException ("IsTransfered Invalid value - " + IsTransfered + " - Reference_ID=1200157 - A - N - P - R - Y");		set_Value (COLUMNNAME_IsTransfered, IsTransfered);
	}
