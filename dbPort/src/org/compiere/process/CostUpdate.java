...
public class CostUpdate extends SvrProcess
{
	...
	{
		//expert: Se comento para permitir generar costos a nivel organizacion, eruiz 4-Julio-2008
	...
	{
		//expert: Asignamos la organizacion de logueo, como Compiere solo creaba costos por cliente, asignaba organizacion
		//0 por default, eso no sirve para MedSys, eruiz 04-Jul-2008
		MCost cost = MCost.get(product, 0, as, Integer.parseInt(getCtx().getProperty("#AD_Org_ID")), m_ce.getM_CostElement_ID(), null);//TODO  twry trxName
		if (cost.is_new())
			return cost.save();
		return false;
	}	//	createNew
