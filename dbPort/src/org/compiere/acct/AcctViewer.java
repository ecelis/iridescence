	...
	implements ActionListener, ChangeListener
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 104971448684587742L;
...
//		tabbedPane.add(graphPanel,   Msg.getMsg(Env.getCtx(), "ViewerGraph"));
		...
		//Omar de la Rosa 20/10/2008
		bExport.setIcon(Env.getImageIcon("Import16.gif"));
		bExport.setToolTipText(Msg.getMsg(Env.getCtx(), "ExportExcel"));
	...
	//	log.info(e.getActionCommand());
		...
		//Omar de la Rosa 20/10/2008
			...
			Env.setContext(Env.getCtx(), "#ExportExcel", true);			
			actionQuery();
		}
		//Fin de Omar de la Rosa
		//  InfoButtons
	...
	private int actionButton(CButton button)
	{
		...
		//EXPERT:Omar de la Rosa 25/Jun/08
			if(tableName.equalsIgnoreCase("AD_OrgTrx"))
				tableName = "AD_Org"; 
			if(lookupColumn.equalsIgnoreCase("AD_OrgTrx_ID"))
				lookupColumn = "AD_Org_ID";
			if(tableName.equalsIgnoreCase("UserElement1")){
				whereClause = "";
				tableName = "M_Locator";
			}
			if(lookupColumn.equals("UserElement1_ID")){
				lookupColumn = "M_Locator_ID";
				keyColumn = "M_Locator_ID";
			}
		//FIN Omar de la Rosa
