...
public class X_T_Transaction extends PO implements I_T_Transaction, I_Persistent 
{
	...
	public void setMovementType (String MovementType)
	{
		...
		if (MovementType.equals("C-") || MovementType.equals("C+") || MovementType.equals("V+") || MovementType.equals("V-") || MovementType.equals("I-") || MovementType.equals("I+") || MovementType.equals("M-") || MovementType.equals("M+") || MovementType.equals("P+") || MovementType.equals("P-") || MovementType.equals("W+") || MovementType.equals("W-") || MovementType.equals("S+")); else throw new IllegalArgumentException ("MovementType Invalid value - " + MovementType + " - Reference_ID=189 - C- - C+ - V+ - V- - I- - I+ - M- - M+ - P+ - P- - W+ - W- - S+");		set_Value (COLUMNNAME_MovementType, MovementType);
	}
