...
public class MMatchInv extends X_M_MatchInv
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2285307554113956387L;
	 ...
	 *	@return array of matches
	 */
	public static MMatchInv[] get(Properties ctx, int M_InOutLine_ID, String trxName) {

		if (M_InOutLine_ID == 0) {
			return new MMatchInv[] {};
		}

		List<MMatchInv> list = getList(ctx, M_InOutLine_ID, trxName);
	...
	public static List<MMatchInv> getList(Properties ctx, int inOutLineID, String trxName) {
	...
	protected boolean beforeDelete ()
	{
		if (isPosted())
		{
			if (!MPeriod.isOpen(getCtx(), getDateTrx(), MDocType.DOCBASETYPE_MatchInvoice, getAD_Org_ID()))
				return false;
			setPosted(false);
