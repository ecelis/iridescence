...
public class X_CM_ChatType extends PO implements I_CM_ChatType, I_Persistent 
{
	...
	/** ModerationType AD_Reference_ID=1200265 */
	public static final int MODERATIONTYPE_AD_Reference_ID=1200265;
	/** Not moderated = N */
	...
	public void setModerationType (String ModerationType)
	{
		...
		if (ModerationType == null || ModerationType.equals("N") || ModerationType.equals("B") || ModerationType.equals("A")); else throw new IllegalArgumentException ("ModerationType Invalid value - " + ModerationType + " - Reference_ID=1200265 - N - B - A");		set_Value (COLUMNNAME_ModerationType, ModerationType);
	}
