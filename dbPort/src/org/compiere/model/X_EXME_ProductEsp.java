...
/** Generated Model for EXME_ProductEsp
 *  @author Generated Class 
 *  @version Release 1.2 - $Id$ */
public class X_EXME_ProductEsp extends PO implements I_EXME_ProductEsp, I_Persistent 
{
    ...
    public X_EXME_ProductEsp (Properties ctx, int EXME_ProductEsp_ID, String trxName)
    {
      super (ctx, EXME_ProductEsp_ID, trxName);
    ...
    /** Load Constructor */
    public X_EXME_ProductEsp (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_ProductEsp[")
