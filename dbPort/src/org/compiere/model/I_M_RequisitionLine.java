...
public interface I_M_RequisitionLine 
{
    ...
    /** Column name Qty_Vol */
    public static final String COLUMNNAME_Qty_Vol = "Qty_Vol";

	/** Set Qty Pack.
	  * Quantity specified for the Pack UOM
	  */
	public void setQty_Vol (BigDecimal Qty_Vol);

	/** Get Qty Pack.
	  * Quantity specified for the Pack UOM
	  */
	public BigDecimal getQty_Vol();
}
