 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: ALoginRes.java,v 1.5 2006/08/23 00:33:36 mrojas Exp $
 */
public final class ALoginRes extends ListResourceBundle
{
	...
	{ "AppServerNotFound",  "Application Server not found" }, //expert : miguel rojas
	{ "ServiceStation",  	"Service Station" } ,//expert : miguel rojas
	{ "ErrorDeactivarUsuario",  "It was not possible to disable the user" },
	{ "ErrorUsuarioDesactivado",  "The user has been disabled for security" },
	{ "ErrorEnviar",  "Could not send the activation email" },
	{ "License",  "License" },
	{ "ErrorLicencia",  "There was an error with the license, check if installed" },
	{ "error.terminoLicencia",  "The terms of the license have not been met" },
	};
