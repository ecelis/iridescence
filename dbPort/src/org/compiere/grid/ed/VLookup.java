 ...
 *
 *  @author 	Jorg Janke
 *  @version 	$Id: VLookup.java,v 1.4 2006/08/10 01:00:27 jjanke Exp $
 */
	...
	implements VEditor, ActionListener, FocusListener
{
		...
		Lookup lookup)
	{
		...
		if (columnName.equals("C_BPartner_ID"))
			...
			m_button.setIcon(Env.getImageIcon("Product10.png"));
		else
	...
	private String getDirectAccessSQL (String text)
	{
		...
		{
			sql.append("SELECT AD_User_ID FROM AD_User WHERE Name LIKE ")
				.append(DB.TO_STRING(text));
			m_tableName = "AD_User";
