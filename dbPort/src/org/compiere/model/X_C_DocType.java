...
// N
	...
	/** Cgo. a Cta. Pac. = XCP */
	public static final String DOCBASETYPE_CgoACtaPac = "XCP";
	/** Medsys = MED */
	public static final String DOCBASETYPE_Medsys = "MED";
	/** AR DebitMemo = ARD */
	public static final String DOCBASETYPE_ARDebitMemo = "ARD";
	/** AP Debit Memo = APD */
	public static final String DOCBASETYPE_APDebitMemo = "APD";
	/** Internal Use Inventory = MSG */
	public static final String DOCBASETYPE_InternalUseInventory = "MSG";
	...
	/** Cgos. a Cta. Pac. = XC */
	public static final String DOCSUBTYPESO_CgosACtaPac = "XC";
	/** Sales Receipt = SR */
	public static final String DOCSUBTYPESO_SalesReceipt = "SR";
	/** Jorunal = JO */
	public static final String DOCSUBTYPESO_Jorunal = "JO";
	/** Batch = BA */
	public static final String DOCSUBTYPESO_Batch = "BA";
	/** Set SO Sub Type.
		@param DocSubTypeSO 
	...
	public void setDocSubTypeSO (String DocSubTypeSO)
	{
		...
		if (DocSubTypeSO == null || DocSubTypeSO.equals("WI") || DocSubTypeSO.equals("WR") || DocSubTypeSO.equals("WP") || DocSubTypeSO.equals("SO") || DocSubTypeSO.equals("ON") || DocSubTypeSO.equals("OB") || DocSubTypeSO.equals("RM") || DocSubTypeSO.equals("PR") || DocSubTypeSO.equals("XC") || DocSubTypeSO.equals("SR") || DocSubTypeSO.equals("JO") || DocSubTypeSO.equals("BA")); else throw new IllegalArgumentException ("DocSubTypeSO Invalid value - " + DocSubTypeSO + " - Reference_ID=148 - WI - WR - WP - SO - ON - OB - RM - PR - XC - SR - JO - BA");		set_Value (COLUMNNAME_DocSubTypeSO, DocSubTypeSO);
	}
