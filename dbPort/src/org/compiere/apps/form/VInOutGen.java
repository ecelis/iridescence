 ...
 *
 *  @author Jorg Janke
 *  @version $Id: VInOutGen.java,v 1.4 2006/08/23 00:33:36 mrojas Exp $
 */
		...
		ChangeListener, TableModelListener, ASyncProcess
{
	...
	void jbInit() throws Exception
	{
		...
		lBPartner.setText(Msg.translate(Env.getCtx(), "C_BPartner_ID")); //EXPERT: gisela lee : mensaje para socio de negocios traducido
