...
// U
	...
	{
		set_Value (COLUMNNAME_ColorHex, ColorHex);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_ColorHex);
	}
	...
	{
		if (ItemName == null)
			throw new IllegalArgumentException ("ItemName is mandatory.");
		set_ValueNoCheck (COLUMNNAME_ItemName, ItemName);
	}
