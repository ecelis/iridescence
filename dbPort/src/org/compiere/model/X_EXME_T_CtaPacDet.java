...
/** Generated Model for EXME_T_CtaPacDet
 *  @author Generated Class 
 *  @version Release 1.2 - $Id$ */
public class X_EXME_T_CtaPacDet extends PO implements I_EXME_T_CtaPacDet, I_Persistent 
{
    ...
    public X_EXME_T_CtaPacDet (Properties ctx, int EXME_T_CtaPacDet_ID, String trxName)
    {
      super (ctx, EXME_T_CtaPacDet_ID, trxName);
      /** if (EXME_T_CtaPacDet_ID == 0)
        {
			setAD_Session_ID (0);
			setAD_User_ID (0);
    ...
    /** Load Constructor */
    public X_EXME_T_CtaPacDet (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_T_CtaPacDet[")
	...
	/** Set Temporal Patient Account Details.
		@param EXME_T_CtaPacDet_ID Temporal Patient Account Details	  */
	public void setEXME_T_CtaPacDet_ID (int EXME_T_CtaPacDet_ID)
	{
		if (EXME_T_CtaPacDet_ID < 1)
			 throw new IllegalArgumentException ("EXME_T_CtaPacDet_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_EXME_T_CtaPacDet_ID, Integer.valueOf(EXME_T_CtaPacDet_ID));
	}

	/** Get Temporal Patient Account Details.
		@return Temporal Patient Account Details	  */
	public int getEXME_T_CtaPacDet_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_EXME_T_CtaPacDet_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
