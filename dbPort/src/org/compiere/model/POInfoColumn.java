 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: POInfoColumn.java,v 1.5 2006/08/23 01:32:38 mrojas Exp $
 */
public class POInfoColumn implements Serializable
{
	 ...
	 * @param columnPrintName Print Name
	 ...
	 */
	public POInfoColumn (int ad_Column_ID, String columnName, String columnPrintName, String columnSQL,
		int displayType, boolean isMandatory, boolean isUpdateable,
		String defaultLogic, String columnLabel,
		String columnDescription, boolean isKey,
		boolean isParent, int ad_Reference_Value_ID,
		String validationCode, int fieldLength, String valueMin,
		String valueMax, boolean isTranslated, boolean isEncrypted, boolean isAllowLogging, boolean isSearchColumn)
	{
		AD_Column_ID = ad_Column_ID;
		ColumnName = columnName;
		ColumnPrintName = columnPrintName;
		ColumnSQL = columnSQL;
	...
	/** Para uso en ventanas de busqueda web */
	public boolean		IsSelectionColumn;// Expert:Hassan
	
	public boolean isSearchColumn;
	
	public String ColumnPrintName;
