 ...
 *	Based on RV_Aging.
 *  @author Jorg Janke
 *  @version $Id: Aging.java,v 1.4 2006/07/30 00:51:01 jjanke Exp $
 */
public class Aging extends SvrProcess
{
	...
	protected void prepare()
	{
		...
		if (p_StatementDate == null)
			p_StatementDate = DB.getTimestampForOrg(Env.getCtx());
		else
			m_statementOffset = TimeUtil.getDaysBetween(DB.getTimestampForOrg(Env.getCtx()), p_StatementDate);
	}	//	prepare
