...
public final class ImpFormat
{
	...
	public void setFormatType(String newFormatType)
	{
		if (newFormatType.equals(FORMATTYPE_FIXED) || newFormatType.equals(FORMATTYPE_COMMA)
			|| newFormatType.equals(FORMATTYPE_TAB) || newFormatType.equals(FORMATTYPE_XML) || newFormatType.equals(FORMATTYPE_PIPE))
			m_formatType = newFormatType;
		else
			throw new IllegalArgumentException("FormatType must be F/C/T/X/P");
	}   //  setFormatType

	/**
	 *  Set Format Type
	 *  @return format type  - F/C/T/X/P
	 */
	...
	private String parseFlexFormat (String line, String formatType, int fieldNo)
	{
		...
		if (formatType.equals(FORMATTYPE_COMMA))
			...
			delimiter = '\t';
		else if (formatType.equals(FORMATTYPE_PIPE))
			delimiter = '|';
		else			
