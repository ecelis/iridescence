...
// E
	...
	/** Set Help Base URL.
		@param Help_Base_URL 
		Base URL for the help system
	  */
	public void setHelp_Base_URL (String Help_Base_URL)
	{
		set_Value (COLUMNNAME_Help_Base_URL, Help_Base_URL);
	}

	/** Get Help Base URL.
		@return Base URL for the help system
	  */
	public String getHelp_Base_URL () 
	{
		return (String)get_Value(COLUMNNAME_Help_Base_URL);
	}
