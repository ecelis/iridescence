...
/** Generated Model for EXME_PacRespDt
 *  @author Generated Class 
 *  @version Release 1.2 - $Id$ */
public class X_EXME_PacRespDt extends PO implements I_EXME_PacRespDt, I_Persistent 
{
    ...
    public X_EXME_PacRespDt (Properties ctx, int EXME_PacRespDt_ID, String trxName)
    {
      super (ctx, EXME_PacRespDt_ID, trxName);
      /** if (EXME_PacRespDt_ID == 0)
        {
			setEXME_PacCuest_ID (0);
			setEXME_Paciente_ID (0);
			setEXME_PacRespDt_ID (0);
    ...
    /** Load Constructor */
    public X_EXME_PacRespDt (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_PacRespDt[")
	...
	/** Set Detail of Patient Answer.
		@param EXME_PacRespDt_ID Detail of Patient Answer	  */
	public void setEXME_PacRespDt_ID (int EXME_PacRespDt_ID)
	{
		if (EXME_PacRespDt_ID < 1)
			 throw new IllegalArgumentException ("EXME_PacRespDt_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_EXME_PacRespDt_ID, Integer.valueOf(EXME_PacRespDt_ID));
	}

	/** Get Detail of Patient Answer.
		@return Detail of Patient Answer	  */
	public int getEXME_PacRespDt_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_EXME_PacRespDt_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
