...
/** Generated Model for EXME_SubEstacion
 *  @author Generated Class 
 *  @version Release 1.2 - $Id$ */
public class X_EXME_SubEstacion extends PO implements I_EXME_SubEstacion, I_Persistent 
{
    ...
    public X_EXME_SubEstacion (Properties ctx, int EXME_SubEstacion_ID, String trxName)
    {
      super (ctx, EXME_SubEstacion_ID, trxName);
      /** if (EXME_SubEstacion_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_EXME_SubEstacion (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_SubEstacion[")
	...
	public void setEXME_SubEstacion_ID (int EXME_SubEstacion_ID)
	{
		...
		set_ValueNoCheck (COLUMNNAME_EXME_SubEstacion_ID, Integer.valueOf(EXME_SubEstacion_ID));
	}
