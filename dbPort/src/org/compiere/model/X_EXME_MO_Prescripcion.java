...
/** Generated Model for EXME_MO_Prescripcion
 *  @author Generated Class 
 *  @version Release 1.2 - $Id$ */
public class X_EXME_MO_Prescripcion extends PO implements I_EXME_MO_Prescripcion, I_Persistent 
{
    ...
    public X_EXME_MO_Prescripcion (Properties ctx, int EXME_MO_Prescripcion_ID, String trxName)
    {
      super (ctx, EXME_MO_Prescripcion_ID, trxName);
      /** if (EXME_MO_Prescripcion_ID == 0)
        {
			setDocumentNo (null);
    ...
    /** Load Constructor */
    public X_EXME_MO_Prescripcion (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_MO_Prescripcion[")
	...
	public void setEXME_MO_Prescripcion_ID (int EXME_MO_Prescripcion_ID)
	{
		...
		set_ValueNoCheck (COLUMNNAME_EXME_MO_Prescripcion_ID, Integer.valueOf(EXME_MO_Prescripcion_ID));
	}
