...
// U
    ...
    {
        Class<?> clazz = MTable.getClass(I_EXP_Processor.Table_Name);
        I_EXP_Processor result = null;
        try	{
	        Constructor<?> constructor = null;
	    	constructor = clazz.getDeclaredConstructor(new Class[]{Properties.class, int.class, String.class});
    	    result = (I_EXP_Processor)constructor.newInstance(new Object[] {getCtx(), new Integer(getEXP_Processor_ID()), get_TrxName()});
        } catch (Exception e) {
