...
/** Generated Model for I_EXME_Pre_Reclas
 *  @author Generated Class 
 *  @version Release 1.2 - $Id$ */
public class X_I_EXME_Pre_Reclas extends PO implements I_I_EXME_Pre_Reclas, I_Persistent 
{
    ...
    public X_I_EXME_Pre_Reclas (Properties ctx, int I_EXME_Pre_Reclas_ID, String trxName)
    {
      super (ctx, I_EXME_Pre_Reclas_ID, trxName);
      /** if (I_EXME_Pre_Reclas_ID == 0)
        {
			setI_EXME_Pre_Reclas_ID (0);
        } */
    }

    /** Load Constructor */
    public X_I_EXME_Pre_Reclas (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_I_EXME_Pre_Reclas[")
	...
	/** Set AD_OrgTrx_Value.
		@param AD_OrgTrx_Value 
		Transactional Organization Value
	  */
	public void setAD_OrgTrx_Value (int AD_OrgTrx_Value)
	{
		set_Value (COLUMNNAME_AD_OrgTrx_Value, Integer.valueOf(AD_OrgTrx_Value));
	}

	/** Get AD_OrgTrx_Value.
		@return Transactional Organization Value
	  */
	public int getAD_OrgTrx_Value () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_AD_OrgTrx_Value);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	{
		set_Value (COLUMNNAME_EXME_Ocupacion_Clas_Value, EXME_Ocupacion_Clas_Value);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_EXME_Ocupacion_Clas_Value);
	}
    ...
    {
        Class<?> clazz = MTable.getClass(I_EXME_Pre_Reclas.Table_Name);
        I_EXME_Pre_Reclas result = null;
        try	{
	        Constructor<?> constructor = null;
	    	constructor = clazz.getDeclaredConstructor(new Class[]{Properties.class, int.class, String.class});
    	    result = (I_EXME_Pre_Reclas)constructor.newInstance(new Object[] {getCtx(), new Integer(getEXME_Pre_Reclas_ID()), get_TrxName()});
        } catch (Exception e) {
	        log.log(Level.SEVERE, "(id) - Table=" + Table_Name + ",Class=" + clazz, e);
	        log.saveError("Error", "Table=" + Table_Name + ",Class=" + clazz);
           throw new RuntimeException( e );
	...
	/** Set Pre-reclassification.
		@param EXME_Pre_Reclas_ID Pre-reclassification	  */
	public void setEXME_Pre_Reclas_ID (int EXME_Pre_Reclas_ID)
	{
		if (EXME_Pre_Reclas_ID < 1) 
			set_Value (COLUMNNAME_EXME_Pre_Reclas_ID, null);
		else 
			set_Value (COLUMNNAME_EXME_Pre_Reclas_ID, Integer.valueOf(EXME_Pre_Reclas_ID));
	}

	/** Get Pre-reclassification.
		@return Pre-reclassification	  */
	public int getEXME_Pre_Reclas_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_EXME_Pre_Reclas_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set I_EXME_Pre_Reclas_ID.
		@param I_EXME_Pre_Reclas_ID I_EXME_Pre_Reclas_ID	  */
	public void setI_EXME_Pre_Reclas_ID (int I_EXME_Pre_Reclas_ID)
	{
		if (I_EXME_Pre_Reclas_ID < 1)
			 throw new IllegalArgumentException ("I_EXME_Pre_Reclas_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_I_EXME_Pre_Reclas_ID, Integer.valueOf(I_EXME_Pre_Reclas_ID));
	}

	/** Get I_EXME_Pre_Reclas_ID.
		@return I_EXME_Pre_Reclas_ID	  */
	public int getI_EXME_Pre_Reclas_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_I_EXME_Pre_Reclas_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
