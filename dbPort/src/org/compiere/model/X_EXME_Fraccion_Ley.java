...
/** Generated Model for EXME_Fraccion_Ley
 *  @author Generated Class 
 *  @version Release 1.2 - $Id$ */
public class X_EXME_Fraccion_Ley extends PO implements I_EXME_Fraccion_Ley, I_Persistent 
{
    ...
    public X_EXME_Fraccion_Ley (Properties ctx, int EXME_Fraccion_Ley_ID, String trxName)
    {
      super (ctx, EXME_Fraccion_Ley_ID, trxName);
      /** if (EXME_Fraccion_Ley_ID == 0)
        {
			setEXME_Fraccion_Ley_ID (0);
			setName (null);
			setValue (null);
        } */
    }
    ...
    /** Load Constructor */
    public X_EXME_Fraccion_Ley (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_Fraccion_Ley[")
	...
	public void setEXME_Fraccion_Ley_ID (int EXME_Fraccion_Ley_ID)
	{
		if (EXME_Fraccion_Ley_ID < 1)
			 throw new IllegalArgumentException ("EXME_Fraccion_Ley_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_EXME_Fraccion_Ley_ID, Integer.valueOf(EXME_Fraccion_Ley_ID));
	}
