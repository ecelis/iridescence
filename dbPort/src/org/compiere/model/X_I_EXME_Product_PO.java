...
/** Generated Model for I_EXME_Product_PO
 *  @author Generated Class 
 *  @version Version @VERSION@ - $Id$ */
public class X_I_EXME_Product_PO extends PO implements I_I_EXME_Product_PO, I_Persistent 
{
    ...
    public X_I_EXME_Product_PO (Properties ctx, int I_EXME_Product_PO_ID, String trxName)
    {
      super (ctx, I_EXME_Product_PO_ID, trxName);
      /** if (I_EXME_Product_PO_ID == 0)
        {
			setI_EXME_Product_PO_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_I_EXME_Product_PO (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_I_EXME_Product_PO[")
	...
	/** Set Company Value.
		@param C_BPartner_Value Company Value	  */
	...
	/** Set Import Product Purchasing.
		@param I_EXME_Product_PO_ID 
		Import Product Purchasing
	  */
	public void setI_EXME_Product_PO_ID (int I_EXME_Product_PO_ID)
	{
		if (I_EXME_Product_PO_ID < 1)
			 throw new IllegalArgumentException ("I_EXME_Product_PO_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_I_EXME_Product_PO_ID, Integer.valueOf(I_EXME_Product_PO_ID));
	}

	/** Get Import Product Purchasing.
		@return Import Product Purchasing
	  */
	public int getI_EXME_Product_PO_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_I_EXME_Product_PO_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
