...
/** Generated Model for EXME_CtaCuest
 *  @author Generated Class 
 *  @version Version @VERSION@ - $Id$ */
public class X_EXME_CtaCuest extends PO implements I_EXME_CtaCuest, I_Persistent 
{
    ...
    public X_EXME_CtaCuest (Properties ctx, int EXME_CtaCuest_ID, String trxName)
    {
      super (ctx, EXME_CtaCuest_ID, trxName);
      /** if (EXME_CtaCuest_ID == 0)
        {
			setEXME_CtaCuest_ID (0);
        } */
    }

    /** Load Constructor */
    public X_EXME_CtaCuest (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_CtaCuest[")
	...
	{
		if (EXME_CtaCuest_ID < 1)
			 throw new IllegalArgumentException ("EXME_CtaCuest_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_EXME_CtaCuest_ID, Integer.valueOf(EXME_CtaCuest_ID));
	}

	/** Get Patient acct. quest. ID.
		@return Patient account questionnaire ID
	  */
	public int getEXME_CtaCuest_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_EXME_CtaCuest_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
