...
public class CLogMgt
{
	...
	public static StringBuffer getInfo (StringBuffer sb)
	{
		...
		//
		sb.append(getMsg("AD_User_ID")).append(eq)  .append(Env.getAD_User_Name(Env.getCtx())).append(NL);
		sb.append(getMsg("AD_Role_ID")).append(eq)  .append(Env.getAD_Role_Name(Env.getCtx())).append(NL);
		//
		sb.append(getMsg("AD_Client_ID")).append(eq).append(Env.getAD_Client_Name(Env.getCtx())).append(NL);
		sb.append(getMsg("AD_Org_ID")).append(eq)   .append(Env.getAD_Org_Name(Env.getCtx())).append(NL);
		//
		...
		if (mf != null)
		{
			...
			if (atts != null)
			{
				Iterator<Object> it = atts.keySet().iterator();
				while (it.hasNext())
				{
					Object key = it.next();
	...
	private static String getServerInfo()
	{
		...
		sb.append(")\n  ");
		//
		boolean remoteObjects = false;
		boolean remoteProcess = false;
