 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: AMenuStartItem.java,v 1.4 2006/08/23 00:33:36 mrojas Exp $
 */
public class AMenuStartItem extends Thread implements ActionListener
{
	...
	public void run()
	{
		...
		{
			//expert : miguel rojas
			if(Env.getContext(Env.getCtx(), "#AccesoUsuario").equalsIgnoreCase("no"))
			...
			if (rs.next())	//	should only be one
			{
				...
				/* EXPERT: mrojas */
				else if (Action.equals("S"))		//	Struts
				{
					ADialog.error(0, null, "Error", "Opcion solo para Web");
				}
				/* EXPERT: mrojas */
				else
