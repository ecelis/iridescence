...
public class RColumn
{
		...
		String sql,	int AD_Reference_Value_ID, String refColumnName)
	{
		...
		else
		{
			...
			{
			    //Expert: Omar de la Rosa
				//m_colSQL += ",(" + MLookupFactory.getLookup_TableDirEmbed(// Debe ser el nombre de la columna de Fact_Acct
				m_colSQL = columnName + ",(" + MLookupFactory.getLookup_TableDirEmbed(
					language, refColumnName, RModel.TABLE_ALIAS, refColumnName, columnName) + ")";
				m_isIDcol = true;
			}
