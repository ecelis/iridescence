...
public class ProductCost
{
	...
	public MAccount getAccount(int AcctType, MAcctSchema as)
	{
		...
		sql.append(" SELECT P_Revenue_Acct, P_Expense_Acct, P_Asset_Acct, P_Cogs_Acct,  ")	//	1..4
		.append(" P_PurchasePriceVariance_Acct, P_InvoicePriceVariance_Acct,  ")	//	5..6
		.append(" P_TradeDiscountRec_Acct, P_TradeDiscountGrant_Acct, ")			//	7..8
		.append(" P_CostAdjustment_Acct, P_InventoryClearing_Acct  ")			//	9..10
		.append(" FROM M_Product_Acct  ")
		.append(" WHERE M_Product_ID = ? AND C_AcctSchema_ID IN (?) ")
...
//			pstmt.setInt(3, Env.getContextAsInt(m_product.getCtx(), "$C_DefaultAcctSchema_ID"));
	...
	public BigDecimal getProductCosts (MAcctSchema as, int AD_Org_ID, 
		...
		**/
		...
		//
		BigDecimal cost = MCost.getCurrentCost (m_product
