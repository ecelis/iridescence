...
/** Generated Model for EXME_Reg_Diario
 *  @author Generated Class 
 *  @version Release 1.2 - $Id$ */
public class X_EXME_Reg_Diario extends PO implements I_EXME_Reg_Diario, I_Persistent 
{
    ...
    public X_EXME_Reg_Diario (Properties ctx, int EXME_Reg_Diario_ID, String trxName)
    {
      super (ctx, EXME_Reg_Diario_ID, trxName);
      /** if (EXME_Reg_Diario_ID == 0)
        {
			setEXME_Reg_Diario_ID (0);
    ...
    /** Load Constructor */
    public X_EXME_Reg_Diario (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_Reg_Diario[")
	...
	{
		set_Value (COLUMNNAME_Cartas_Comp, Cartas_Comp);
	}

	/** Get Intention Letter.
		@return Intention Letter
	  */
	public BigDecimal getCartas_Comp () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_Cartas_Comp);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	{
		set_Value (COLUMNNAME_Entre_Med_Soc, Entre_Med_Soc);
	}

	/** Get Entre. Med. Soc..
		@return Entre. Med. Soc.
	  */
	public BigDecimal getEntre_Med_Soc () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_Entre_Med_Soc);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Set Daily Registry of Activities.
		@param EXME_Reg_Diario_ID 
		Daily Registry of Activities
	  */
	public void setEXME_Reg_Diario_ID (int EXME_Reg_Diario_ID)
	{
		if (EXME_Reg_Diario_ID < 1)
			 throw new IllegalArgumentException ("EXME_Reg_Diario_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_EXME_Reg_Diario_ID, Integer.valueOf(EXME_Reg_Diario_ID));
	}

	/** Get Daily Registry of Activities.
		@return Daily Registry of Activities
	  */
	public int getEXME_Reg_Diario_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_EXME_Reg_Diario_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	public void setFecha_Ctrl (Timestamp Fecha_Ctrl)
	{
		...
		set_ValueNoCheck (COLUMNNAME_Fecha_Ctrl, Fecha_Ctrl);
	}
	...
	{
		set_Value (COLUMNNAME_Otras, Otras);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_Otras);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	{
		set_Value (COLUMNNAME_Present_Casos, Present_Casos);
	}

	/** Get Cases Presentation.
		@return Cases Presentation
	  */
	public BigDecimal getPresent_Casos () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_Present_Casos);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	{
		set_Value (COLUMNNAME_Ser_Com, Ser_Com);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_Ser_Com);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_V_D);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
