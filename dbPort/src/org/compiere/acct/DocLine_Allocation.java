...
public class DocLine_Allocation extends DocLine
{
	...
	private int 		m_C_Charge_ID; // //Expert. TTPR # Posteo Notas de Debito . Con Cargos C_Charge
	...
	public String toString ()
	{
		...
		sb.append(get_ID())
			...
			.append(",C_Charge_ID=").append(m_C_Charge_ID)//Expert. TTPR # Posteo Notas de Debito . Con Cargos C_Charge
			.append("]");
		return sb.toString ();
	}	//	toString
	...
	//Expert. TTPR # Posteo Notas de Debito . Con Cargos C_Charge
	public int getC_Charge_ID() {
		return m_C_Charge_ID;
	}

	public void setC_Charge_ID(int mCChargeID) {
		m_C_Charge_ID = mCChargeID;
	}////Expert. TTPR # Posteo Notas de Debito . Con Cargos C_Charge
