...
public final class ConfirmPanel extends CPanel
{
	...
	public static final CButton createLicenceButton(String text) {
		AppsAction aa = new AppsAction(A_LICENSE, null, text);
		CButton button = (CButton) aa.getButton();
		button.setMargin(s_insets);
		return button;
	}
	...
	/**	Action String License */
	public static final String A_LICENSE = "License";
	 ...
	 *  @param withText with text
	 */
	public ConfirmPanel(boolean withCancelButton, boolean withText) {
		super();
		BorderLayout mainLayout = new BorderLayout();
		this.setLayout(mainLayout);
		this.setName("confirmPanel");
		...
		CPanel okCancel = new CPanel(new FlowLayout(FlowLayout.RIGHT));
		okCancel.setOpaque(false);
		bLicense = createLicenceButton("");
		// okCancel.add(bLicense);
		bCancel = createCancelButton(withText);
		okCancel.add(bCancel);
		bOK = createOKButton(withText);
		okCancel.add(bOK);
		setCancelVisible(withCancelButton);
		this.add(okCancel, BorderLayout.EAST);
		this.add(bLicense, BorderLayout.WEST);
...
//			new DialogButton (action, toolTipText, icon);
	...
	public CButton getbLicense() {
		return bLicense;
	}

	public void setbLicense(CButton bLicense) {
	...
	public void addActionListener(ActionListener al)
	{
		...
		if(bLicense != null)
			((AppsAction)bLicense.getAction()).setDelegate(al);
