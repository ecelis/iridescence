...
public class LayoutEngine implements Pageable, Printable, Doc
{
	...
	private void layout()
	{
		...
		Timestamp now = DB.getTimestampForOrg(getCtx()); //new Timestamp(System.currentTimeMillis());
	...
	private void createStandardHeaderFooter()
	{
		...
		if (ci.getLogoReport_ID() > 0) {
			...
			element = new ImageElement(org.compiere.Compiere.getImageLogoSmall(true));	//	48x15
		}
