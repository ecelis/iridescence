...
/** Generated Model for I_EXME_PaqBase_Version
 *  @author Generated Class 
 *  @version Release 1.2 - $Id$ */
public class X_I_EXME_PaqBase_Version extends PO implements I_I_EXME_PaqBase_Version, I_Persistent 
{
    ...
    public X_I_EXME_PaqBase_Version (Properties ctx, int I_EXME_PaqBase_Version_ID, String trxName)
    {
      super (ctx, I_EXME_PaqBase_Version_ID, trxName);
      /** if (I_EXME_PaqBase_Version_ID == 0)
        {
			setI_EXME_PaqBase_Version_ID (0);
			setI_IsImported (false);
        } */
    }

    /** Load Constructor */
    public X_I_EXME_PaqBase_Version (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_I_EXME_PaqBase_Version[")
	...
	{
		set_Value (COLUMNNAME_AD_OrgTrx_Value, AD_OrgTrx_Value);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_AD_OrgTrx_Value);
	}
	...
	/** Set Base Package_Value.
		@param EXME_PaqBase_Value Base Package_Value	  */
	public void setEXME_PaqBase_Value (String EXME_PaqBase_Value)
	{
		set_Value (COLUMNNAME_EXME_PaqBase_Value, EXME_PaqBase_Value);
	}

	/** Get Base Package_Value.
		@return Base Package_Value	  */
	public String getEXME_PaqBase_Value () 
	{
		return (String)get_Value(COLUMNNAME_EXME_PaqBase_Value);
	}
	...
	/** Set I_EXME_PaqBase_Version_ID.
		@param I_EXME_PaqBase_Version_ID I_EXME_PaqBase_Version_ID	  */
	public void setI_EXME_PaqBase_Version_ID (int I_EXME_PaqBase_Version_ID)
	{
		if (I_EXME_PaqBase_Version_ID < 1)
			 throw new IllegalArgumentException ("I_EXME_PaqBase_Version_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_I_EXME_PaqBase_Version_ID, Integer.valueOf(I_EXME_PaqBase_Version_ID));
	}

	/** Get I_EXME_PaqBase_Version_ID.
		@return I_EXME_PaqBase_Version_ID	  */
	public int getI_EXME_PaqBase_Version_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_I_EXME_PaqBase_Version_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set Price List Value.
		@param M_PRICELIST_VALUE Price List Value	  */
	public void setM_PRICELIST_VALUE (String M_PRICELIST_VALUE)
	{
		set_Value (COLUMNNAME_M_PRICELIST_VALUE, M_PRICELIST_VALUE);
	}

	/** Get Price List Value.
		@return Price List Value	  */
	public String getM_PRICELIST_VALUE () 
	{
		return (String)get_Value(COLUMNNAME_M_PRICELIST_VALUE);
	}
