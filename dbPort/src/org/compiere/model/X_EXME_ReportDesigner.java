...
/** Generated Model for EXME_ReportDesigner
 *  @author Generated Class 
 *  @version Version @VERSION@ - $Id$ */
public class X_EXME_ReportDesigner extends PO implements I_EXME_ReportDesigner, I_Persistent 
{
    ...
    public X_EXME_ReportDesigner (Properties ctx, int EXME_ReportDesigner_ID, String trxName)
    {
      super (ctx, EXME_ReportDesigner_ID, trxName);
      /** if (EXME_ReportDesigner_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_EXME_ReportDesigner (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_ReportDesigner[")
