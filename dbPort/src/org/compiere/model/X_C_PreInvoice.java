...
public class X_C_PreInvoice extends PO implements I_C_PreInvoice, I_Persistent 
{
	...
	{
		set_Value (COLUMNNAME_GenerateTo, Boolean.valueOf(GenerateTo));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_GenerateTo);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set Collection Status.
	  ...
	  */
	public void setInvoiceCollectionType (boolean InvoiceCollectionType)
	{
		set_Value (COLUMNNAME_InvoiceCollectionType, Boolean.valueOf(InvoiceCollectionType));
	}

	/** Get Collection Status.
		@return Invoice Collection Status
	  */
	public boolean isInvoiceCollectionType () 
	{
		Object oo = get_Value(COLUMNNAME_InvoiceCollectionType);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	{
		set_Value (COLUMNNAME_IsTransferred, Boolean.valueOf(IsTransferred));
	}
	...
	public void setTipoOperacion (String TipoOperacion)
	{
		if (TipoOperacion == null)
			throw new IllegalArgumentException ("TipoOperacion is mandatory.");
	...
	public void setVerPoliza (boolean VerPoliza)
	{
		set_Value (COLUMNNAME_VerPoliza, Boolean.valueOf(VerPoliza));
	}

	/** Get Policy.
		@return Policy	  */
	public boolean isVerPoliza () 
	{
		Object oo = get_Value(COLUMNNAME_VerPoliza);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
