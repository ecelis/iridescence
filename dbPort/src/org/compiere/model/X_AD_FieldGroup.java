...
// U
	...
	/** FieldGroupType AD_Reference_ID=1200302 */
	public static final int FIELDGROUPTYPE_AD_Reference_ID=1200302;
	/** Tab = T */
	...
	public void setFieldGroupType (String FieldGroupType)
	{
		...
		if (FieldGroupType == null || FieldGroupType.equals("T") || FieldGroupType.equals("L") || FieldGroupType.equals("C")); else throw new IllegalArgumentException ("FieldGroupType Invalid value - " + FieldGroupType + " - Reference_ID=1200302 - T - L - C");		set_Value (COLUMNNAME_FieldGroupType, FieldGroupType);
	}
