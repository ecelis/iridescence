...
public class X_HR_Payroll extends PO implements I_HR_Payroll, I_Persistent 
{
	...
	public org.compiere.model.I_HR_Contract getHR_Contract() throws RuntimeException 
    {
        Class<?> clazz = MTable.getClass(org.compiere.model.I_HR_Contract.Table_Name);
        org.compiere.model.I_HR_Contract result = null;
        try	{
	        Constructor<?> constructor = null;
	    	constructor = clazz.getDeclaredConstructor(new Class[]{Properties.class, int.class, String.class});
    	    result = (org.compiere.model.I_HR_Contract)constructor.newInstance(new Object[] {getCtx(), new Integer(getHR_Contract_ID()), get_TrxName()});
        } catch (Exception e) {
	        log.log(Level.SEVERE, "(id) - Table=" + Table_Name + ",Class=" + clazz, e);
	        log.saveError("Error", "Table=" + Table_Name + ",Class=" + clazz);
           throw new RuntimeException( e );
