...
// 5
	...
	/** Set Grand Total Order.
		@param GrandTotalOrder Grand Total Order	  */
	public void setGrandTotalOrder (BigDecimal GrandTotalOrder)
	{
		throw new IllegalArgumentException ("GrandTotalOrder is virtual column");	}

	/** Get Grand Total Order.
		@return Grand Total Order	  */
	public BigDecimal getGrandTotalOrder () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_GrandTotalOrder);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	{
		set_Value (COLUMNNAME_Setpoint, Boolean.valueOf(Setpoint));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_Setpoint);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
