...
public class X_AD_Package_Exp_Detail extends PO implements I_AD_Package_Exp_Detail, I_Persistent 
{
	...
	/** DBType AD_Reference_ID=1200272 */
	public static final int DBTYPE_AD_Reference_ID=1200272;
	...
	public void setDBType (String DBType)
	{
		...
		if (DBType == null || DBType.equals("ALL") || DBType.equals("DB2") || DBType.equals("Firebird") || DBType.equals("MySQL") || DBType.equals("Oracle") || DBType.equals("Postgres") || DBType.equals("SQL") || DBType.equals("Sybase")); else throw new IllegalArgumentException ("DBType Invalid value - " + DBType + " - Reference_ID=1200272 - ALL - DB2 - Firebird - MySQL - Oracle - Postgres - SQL - Sybase");		set_Value (COLUMNNAME_DBType, DBType);
	}
	...
	public void setReleaseNo (String ReleaseNo)
	{
		...
		if (ReleaseNo == null || ReleaseNo.equals("Release 3.1.0") || ReleaseNo.equals("Release 3.2.0") || ReleaseNo.equals("Release 3.3.0") || ReleaseNo.equals("Release 2.5.2a") || ReleaseNo.equals("Release 2.5.2b") || ReleaseNo.equals("Release 2.5.2c") || ReleaseNo.equals("Release 2.5.2d") || ReleaseNo.equals("Release 2.5.2e") || ReleaseNo.equals("Release 2.5.3a") || ReleaseNo.equals("Release 2.5.3b") || ReleaseNo.equals("all")); else throw new IllegalArgumentException ("ReleaseNo Invalid value - " + ReleaseNo + " - Reference_ID=1200271 - Release 3.1.0 - Release 3.2.0 - Release 3.3.0 - Release 2.5.2a - Release 2.5.2b - Release 2.5.2c - Release 2.5.2d - Release 2.5.2e - Release 2.5.3a - Release 2.5.3b - all");		set_Value (COLUMNNAME_ReleaseNo, ReleaseNo);
	}
	...
	/** Type AD_Reference_ID=1200273 */
	public static final int TYPE_AD_Reference_ID=1200273;
	/** Workflow = F */
	...
	public void setType (String Type)
	{
		...
		if (Type.equals("F") || Type.equals("REF") || Type.equals("V") || Type.equals("MSG") || Type.equals("PFT") || Type.equals("MV") || Type.equals("ET") || Type.equals("B") || Type.equals("C") || Type.equals("D") || Type.equals("IMP") || Type.equals("M") || Type.equals("P") || Type.equals("R") || Type.equals("S") || Type.equals("SNI") || Type.equals("SQL") || Type.equals("T") || Type.equals("W") || Type.equals("X")); else throw new IllegalArgumentException ("Type Invalid value - " + Type + " - Reference_ID=1200273 - F - REF - V - MSG - PFT - MV - ET - B - C - D - IMP - M - P - R - S - SNI - SQL - T - W - X");		set_Value (COLUMNNAME_Type, Type);
	}
