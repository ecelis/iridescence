...
/** Generated Model for EXME_ProgramaInv
 *  @author Generated Class 
 *  @version Release 1.2 - $Id$ */
public class X_EXME_ProgramaInv extends PO implements I_EXME_ProgramaInv, I_Persistent 
{
    ...
    public X_EXME_ProgramaInv (Properties ctx, int EXME_ProgramaInv_ID, String trxName)
    {
      super (ctx, EXME_ProgramaInv_ID, trxName);
      /** if (EXME_ProgramaInv_ID == 0)
        {
			setDocAction (null);
			setDocStatus (null);
			setDocumentNo (null);
    ...
    /** Load Constructor */
    public X_EXME_ProgramaInv (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_ProgramaInv[")
	...
	public void setEXME_ProgramaInv_ID (int EXME_ProgramaInv_ID)
	{
		...
		set_ValueNoCheck (COLUMNNAME_EXME_ProgramaInv_ID, Integer.valueOf(EXME_ProgramaInv_ID));
	}
