 ...
 *
 */
public class GeneraArchivoVte1Test extends TestCase {
	...
	public void testTestPacientesMedida() {
		...
		int num = GeneraArchivoVte1.testPacientesMedida( version,  optionRegistry,  ctx,  trxName,  file,  files);
		assertTrue(num ==1);
	}
	...
	public void testNumerador() {
		int count = GeneraArchivoVte1.testPacientesMedida(true);
		assertTrue(count >= 0);
	}
	...
	public void testDenominador() {
		int count = GeneraArchivoVte1.testPacientesMedida(false);
		assertTrue(count >= 0);
	}
}
