...
/** Generated Model for EXME_TTCtaPacDet
 *  @author Generated Class 
 *  @version Release 1.2 - $Id$ */
public class X_EXME_TTCtaPacDet extends PO implements I_EXME_TTCtaPacDet, I_Persistent 
{
    ...
    public X_EXME_TTCtaPacDet (Properties ctx, int EXME_TTCtaPacDet_ID, String trxName)
    {
      super (ctx, EXME_TTCtaPacDet_ID, trxName);
      /** if (EXME_TTCtaPacDet_ID == 0)
        {
			setAD_Session_ID (0);
			setAD_User_ID (0);
			setBorrarConv (false);
...
// Y
    ...
    /** Load Constructor */
    public X_EXME_TTCtaPacDet (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_TTCtaPacDet[")
	...
	/** Set Patient Account Detail.
		@param EXME_TTCtaPacDet_ID Patient Account Detail	  */
	public void setEXME_TTCtaPacDet_ID (int EXME_TTCtaPacDet_ID)
	{
		if (EXME_TTCtaPacDet_ID < 1)
			 throw new IllegalArgumentException ("EXME_TTCtaPacDet_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_EXME_TTCtaPacDet_ID, Integer.valueOf(EXME_TTCtaPacDet_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_EXME_TTCtaPacDet_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set Patient Account Detail.
		@param Ref_TTCtaPacDet_ID Patient Account Detail	  */
	public void setRef_TTCtaPacDet_ID (int Ref_TTCtaPacDet_ID)
	{
		if (Ref_TTCtaPacDet_ID < 1) 
			set_Value (COLUMNNAME_Ref_TTCtaPacDet_ID, null);
		else 
			set_Value (COLUMNNAME_Ref_TTCtaPacDet_ID, Integer.valueOf(Ref_TTCtaPacDet_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Ref_TTCtaPacDet_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	public void setTipoLinea (String TipoLinea)
	{
		...
		if (TipoLinea.equals("CG") || TipoLinea.equals("PB") || TipoLinea.equals("MP") || TipoLinea.equals("CO") || TipoLinea.equals("DE") || TipoLinea.equals("DS") || TipoLinea.equals("AJ") || TipoLinea.equals("LD") || TipoLinea.equals("EX")); else throw new IllegalArgumentException ("TipoLinea Invalid value - " + TipoLinea + " - Reference_ID=1200090 - CG - PB - MP - CO - DE - DS - AJ - LD - EX");		set_Value (COLUMNNAME_TipoLinea, TipoLinea);
	}
