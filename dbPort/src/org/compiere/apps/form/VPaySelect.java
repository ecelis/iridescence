 ...
 *
 *  @author Jorg Janke
 *  @version $Id: VPaySelect.java,v 1.8 2006/08/23 00:33:36 mrojas Exp $
 */
	...
	implements FormPanel, ActionListener, TableModelListener, ASyncProcess
{
	...
	/** serialVersionUID */
	private static final long serialVersionUID = -4046258692229987524L;
	...
	private void dynInit()
	{
		...
		consulta.append(DB.getTimestampForOrg(Env.getCtx()));//REV
		consulta.append("-paymentTermDueDays(i.C_PaymentTerm_ID,i.DateInvoiced,");
		consulta.append(DB.getTimestampForOrg(Env.getCtx())).append(")");
		...
		m_sql = miniTable.prepareTable(new ColumnInfo[] {
			...
			new ColumnInfo(Msg.getMsg(ctx, "DiscountDate"), consulta.toString(), Timestamp.class),
