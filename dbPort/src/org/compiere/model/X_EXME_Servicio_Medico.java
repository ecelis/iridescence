...
/** Generated Model for EXME_Servicio_Medico
 *  @author Generated Class 
 *  @version Version @VERSION@ - $Id$ */
public class X_EXME_Servicio_Medico extends PO implements I_EXME_Servicio_Medico, I_Persistent 
{
    ...
    public X_EXME_Servicio_Medico (Properties ctx, int EXME_Servicio_Medico_ID, String trxName)
    {
      super (ctx, EXME_Servicio_Medico_ID, trxName);
      /** if (EXME_Servicio_Medico_ID == 0)
        {
			setEXME_Servicio_Medico_ID (0);
			setValue (null);
        } */
    }

    /** Load Constructor */
    public X_EXME_Servicio_Medico (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_Servicio_Medico[")
	...
	public void setEXME_Servicio_Medico_ID (int EXME_Servicio_Medico_ID)
	{
		if (EXME_Servicio_Medico_ID < 1)
			 throw new IllegalArgumentException ("EXME_Servicio_Medico_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_EXME_Servicio_Medico_ID, Integer.valueOf(EXME_Servicio_Medico_ID));
	}
