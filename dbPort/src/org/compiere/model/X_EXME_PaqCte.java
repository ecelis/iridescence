...
/** Generated Model for EXME_PaqCte
 *  @author Generated Class 
 *  @version Release 1.2 - $Id$ */
public class X_EXME_PaqCte extends PO implements I_EXME_PaqCte, I_Persistent 
{
    ...
    public X_EXME_PaqCte (Properties ctx, int EXME_PaqCte_ID, String trxName)
    {
      super (ctx, EXME_PaqCte_ID, trxName);
      /** if (EXME_PaqCte_ID == 0)
        {
			setC_BPartner_ID (0);
			setC_Currency_ID (0);
    ...
    /** Load Constructor */
    public X_EXME_PaqCte (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_PaqCte[")
