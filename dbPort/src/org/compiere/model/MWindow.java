...
public class MWindow extends X_AD_Window
{
	...
	protected boolean afterSave (boolean newRecord, boolean success)
	{
		...
		{
			MRole[] roles = MRole.getOf(getCtx(), "IsManual='N' and isForPatientAccess = 'N' ");
	...
	public static int getWindow_ID(String windowName) {
		int retValue = 0;
		String sql = "SELECT AD_Window_ID FROM AD_Window WHERE Name LIKE ? AND isActive = 'Y' ";
		try {
			retValue = DB.getSQLValue(null, sql, windowName);// Expert: Lama
		} catch (Exception e) {
