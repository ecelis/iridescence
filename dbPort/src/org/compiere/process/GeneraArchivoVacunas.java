 ...
 *
 */
public class GeneraArchivoVacunas{
	
	public GeneraArchivoVacunas(String version, String optionRegistry, Properties ctx, String trxName){
		...
		String sql = "SELECT COUNT(*) " + 
						...
						" ( " +
						    ...
						    " WHERE hv.exme_vacuna_id = " + vacunaID +
						          " AND "+DB.truncDate("exme_edad_anomes(to_char(ep.fechanac,'dd/MM/yyyy'), '" + strIni + "')")+" = " + age +
						          " AND hv.fechaaplica between to_date('" + strIni + "','dd/MM/yyyy') AND to_date('" + strFin + "', 'dd/MM/yyyy') " + 
