...
/** Generated Model for EXME_Pre_Reclas
 *  @author Generated Class 
 *  @version Release 1.2 - $Id$ */
public class X_EXME_Pre_Reclas extends PO implements I_EXME_Pre_Reclas, I_Persistent 
{
    ...
    public X_EXME_Pre_Reclas (Properties ctx, int EXME_Pre_Reclas_ID, String trxName)
    {
      super (ctx, EXME_Pre_Reclas_ID, trxName);
...
// 1
    ...
    /** Load Constructor */
    public X_EXME_Pre_Reclas (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_Pre_Reclas[")
	...
	/** Estatus AD_Reference_ID=1200019 */
	public static final int ESTATUS_AD_Reference_ID=1200019;
	/** Updated = AC */
	public static final String ESTATUS_Updated = "AC";
	/** Initial = IN */
	public static final String ESTATUS_Initial = "IN";
	/** Reclasified = RE */
	public static final String ESTATUS_Reclasified = "RE";
	/** Set Status.
		@param Estatus 
		Status
	  */
	public void setEstatus (String Estatus)
	{
		...
		if (Estatus.equals("AC") || Estatus.equals("IN") || Estatus.equals("RE")); else throw new IllegalArgumentException ("Estatus Invalid value - " + Estatus + " - Reference_ID=1200019 - AC - IN - RE");		set_Value (COLUMNNAME_Estatus, Estatus);
	}
	...
	public void setEXME_Pre_Reclas_ID (int EXME_Pre_Reclas_ID)
	{
		if (EXME_Pre_Reclas_ID < 1)
			 throw new IllegalArgumentException ("EXME_Pre_Reclas_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_EXME_Pre_Reclas_ID, Integer.valueOf(EXME_Pre_Reclas_ID));
	}
