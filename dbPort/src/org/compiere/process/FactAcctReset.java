 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: FactAcctReset.java,v 1.4 2006/08/10 01:00:12 jjanke Exp $
 */
public class FactAcctReset extends SvrProcess
{
	...
	protected String doIt() throws Exception
	{
		...
		.append(" SELECT AD_Table_ID, TableName ")
		.append(" FROM AD_Table t               ")
		.append(" WHERE t.IsView='N'            ");
		
		if (p_AD_Table_ID > 0){
			sql.append(" AND t.AD_Table_ID = ").append(p_AD_Table_ID);
		}
		
		sql.append(" AND EXISTS (SELECT * FROM AD_Column c         ")
		.append("                WHERE t.AD_Table_ID=c.AD_Table_ID ")
		.append("                AND c.ColumnName='Posted'         ")
		.append("                AND c.IsActive='Y')               ")
		.append("    AND AD_Table_ID IN (                          ") 
		.append(MInvoice.Table_ID).append(", ")
		.append(MInOut.Table_ID).append(", ")
		.append(MPayment.Table_ID).append(", ")
		.append(MOrder.Table_ID).append(", ")
		.append(MProjectIssue.Table_ID).append(", ")
		.append(MBankStatement.Table_ID).append(", ")
		.append(MCash.Table_ID).append(", ")
		.append(MAllocationHdr.Table_ID).append(", ")
		.append(MJournal.Table_ID).append(", ")
		.append(MMovement.Table_ID).append(", ")
		.append(MRequisition.Table_ID).append(", ")
		.append(MInventory.Table_ID).append(", ")
		.append(X_M_Production.Table_ID).append(", ")
		.append(MMatchInv.Table_ID).append(", ")
		.append(MMatchPO.Table_ID).append(") ");
