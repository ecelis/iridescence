...
public class CMemoryUsage extends MemoryUsage
{
	...
	public String toJSON() {
		StringBuffer sb = new StringBuffer ();
		sb.append("{\"Init\" : ").append(getInit())
		.append("\",\"Used\"  : \"").append(getUsed())
		.append("\", \"Free\" : \"").append(getFree())
		.append("\",\"FreePercent\" : \"").append(getFreePercent())
		.append("\",\"Committed\" : \"").append(getCommitted())
		.append("\",\"CommittedPercent\" : \"").append(getCommittedPercent())
		.append("\",\"Max\"  : \"").append (getMax())
		.append("\",\"timestamp\" : \"").append(new Timestamp(System.currentTimeMillis())).append("\"}");
		return sb.toString ();
	}
