...
{
   public final static String JNDI_NAME="compiere/Status";
   
   public final static String EJB_NAME="compiereStatus";
   ...
   /**
    * Expert - Devolvemos la fecha del servidor de aplicaciones.
