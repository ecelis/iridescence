...
public class X_M_Transaction extends PO implements I_M_Transaction, I_Persistent 
{
	...
	{
		set_Value (COLUMNNAME_CostAverageI, CostAverageI);
	}

	/** Get Average Cost Invoice.
		@return Average Cost Invoice
	  */
	public BigDecimal getCostAverageI () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_CostAverageI);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	public void setEXME_SalidaGastoLine_ID (int EXME_SalidaGastoLine_ID)
	{
		if (EXME_SalidaGastoLine_ID < 1) 
			set_Value (COLUMNNAME_EXME_SalidaGastoLine_ID, null);
		else 
			set_Value (COLUMNNAME_EXME_SalidaGastoLine_ID, Integer.valueOf(EXME_SalidaGastoLine_ID));
	}
	...
	public static final String MOVEMENTTYPE_InternalUseInventory = "S+";
	/** Set Movement Type.
		@param MovementType 
	...
	public void setMovementType (String MovementType)
	{
		...
		if (MovementType.equals("C-") || MovementType.equals("C+") || MovementType.equals("V+") || MovementType.equals("V-") || MovementType.equals("I-") || MovementType.equals("I+") || MovementType.equals("M-") || MovementType.equals("M+") || MovementType.equals("P+") || MovementType.equals("P-") || MovementType.equals("W+") || MovementType.equals("W-") || MovementType.equals("S+")); else throw new IllegalArgumentException ("MovementType Invalid value - " + MovementType + " - Reference_ID=189 - C- - C+ - V+ - V- - I- - I+ - M- - M+ - P+ - P- - W+ - W- - S+");		set_ValueNoCheck (COLUMNNAME_MovementType, MovementType);
	}
    ...
    {
        Class<?> clazz = MTable.getClass(I_PP_Cost_Collector.Table_Name);
        I_PP_Cost_Collector result = null;
        try	{
	        Constructor<?> constructor = null;
	    	constructor = clazz.getDeclaredConstructor(new Class[]{Properties.class, int.class, String.class});
    	    result = (I_PP_Cost_Collector)constructor.newInstance(new Object[] {getCtx(), new Integer(getPP_Cost_Collector_ID()), get_TrxName()});
        } catch (Exception e) {
	        log.log(Level.SEVERE, "(id) - Table=" + Table_Name + ",Class=" + clazz, e);
	        log.saveError("Error", "Table=" + Table_Name + ",Class=" + clazz);
           throw new RuntimeException( e );
