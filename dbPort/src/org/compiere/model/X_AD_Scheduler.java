...
// F
	...
	/** Set Run Process on IP.
		@param Run_On_IP 
		Run Process on Server With this IP Address
	  */
	public void setRun_On_IP (String Run_On_IP)
	{
		set_Value (COLUMNNAME_Run_On_IP, Run_On_IP);
	}

	/** Get Run Process on IP.
		@return Run Process on Server With this IP Address
	  */
	public String getRun_On_IP () 
	{
		return (String)get_Value(COLUMNNAME_Run_On_IP);
	}
