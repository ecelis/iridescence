...
public class X_I_ProductPrice extends PO implements I_I_ProductPrice, I_Persistent 
{
    ...
    {
      StringBuffer sb = new StringBuffer ("X_I_ProductPrice[")
	...
	/** Set Imported Price.
		@param I_ProductPrice_ID 
		Imported Price
	  */
	public void setI_ProductPrice_ID (int I_ProductPrice_ID)
	{
		if (I_ProductPrice_ID < 1)
			 throw new IllegalArgumentException ("I_ProductPrice_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_I_ProductPrice_ID, Integer.valueOf(I_ProductPrice_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_I_ProductPrice_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
