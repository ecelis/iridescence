...
public class X_A_Asset_Reval_Entry extends PO implements I_A_Asset_Reval_Entry, I_Persistent 
{
	...
	/** Set Asset Reval Entry ID.
		@param A_Asset_Reval_Entry_ID Asset Reval Entry ID	  */
	...
	/** A_Reval_Cal_Method AD_Reference_ID=1200306 */
	public static final int A_REVAL_CAL_METHOD_AD_Reference_ID=1200306;
	/** Default = DFT */
	...
	public void setA_Reval_Cal_Method (String A_Reval_Cal_Method)
	{
		...
		if (A_Reval_Cal_Method.equals("DFT") || A_Reval_Cal_Method.equals("IDF") || A_Reval_Cal_Method.equals("YBF")); else throw new IllegalArgumentException ("A_Reval_Cal_Method Invalid value - " + A_Reval_Cal_Method + " - Reference_ID=1200306 - DFT - IDF - YBF");		set_Value (COLUMNNAME_A_Reval_Cal_Method, A_Reval_Cal_Method);
	}
	...
	/** A_Reval_Effective_Date AD_Reference_ID=1200308 */
	public static final int A_REVAL_EFFECTIVE_DATE_AD_Reference_ID=1200308;
	/** Date Aquired = DA */
	...
	public void setA_Reval_Effective_Date (String A_Reval_Effective_Date)
	{
		...
		if (A_Reval_Effective_Date.equals("DA") || A_Reval_Effective_Date.equals("RD") || A_Reval_Effective_Date.equals("SD")); else throw new IllegalArgumentException ("A_Reval_Effective_Date Invalid value - " + A_Reval_Effective_Date + " - Reference_ID=1200308 - DA - RD - SD");		set_Value (COLUMNNAME_A_Reval_Effective_Date, A_Reval_Effective_Date);
	}
	...
	/** A_Rev_Code AD_Reference_ID=1200309 */
	public static final int A_REV_CODE_AD_Reference_ID=1200309;
	...
	public void setA_Rev_Code (String A_Rev_Code)
	{
		...
		if (A_Rev_Code.equals("R01") || A_Rev_Code.equals("R02") || A_Rev_Code.equals("R03")); else throw new IllegalArgumentException ("A_Rev_Code Invalid value - " + A_Rev_Code + " - Reference_ID=1200309 - R01 - R02 - R03");		set_Value (COLUMNNAME_A_Rev_Code, A_Rev_Code);
	}
