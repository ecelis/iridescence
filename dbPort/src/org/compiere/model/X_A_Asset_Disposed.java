...
// @Date@
	...
	/** A_Disposed_Method AD_Reference_ID=1200317 */
	public static final int A_DISPOSED_METHOD_AD_Reference_ID=1200317;
	/** Cash = C */
	...
	public void setA_Disposed_Method (String A_Disposed_Method)
	{
		...
		if (A_Disposed_Method.equals("C") || A_Disposed_Method.equals("S") || A_Disposed_Method.equals("T1") || A_Disposed_Method.equals("T2")); else throw new IllegalArgumentException ("A_Disposed_Method Invalid value - " + A_Disposed_Method + " - Reference_ID=1200317 - C - S - T1 - T2");		set_Value (COLUMNNAME_A_Disposed_Method, A_Disposed_Method);
	}
	...
	/** A_Disposed_Reason AD_Reference_ID=1200316 */
	public static final int A_DISPOSED_REASON_AD_Reference_ID=1200316;
	/** Charity = C */
	...
	public void setA_Disposed_Reason (String A_Disposed_Reason)
	{
		...
		if (A_Disposed_Reason.equals("C") || A_Disposed_Reason.equals("D") || A_Disposed_Reason.equals("S") || A_Disposed_Reason.equals("S1") || A_Disposed_Reason.equals("S2") || A_Disposed_Reason.equals("T")); else throw new IllegalArgumentException ("A_Disposed_Reason Invalid value - " + A_Disposed_Reason + " - Reference_ID=1200316 - C - D - S - S1 - S2 - T");		set_Value (COLUMNNAME_A_Disposed_Reason, A_Disposed_Reason);
	}
