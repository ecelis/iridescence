...
/** Generated Model for EXME_Pre_Reclas_A
 *  @author Generated Class 
 *  @version Release 1.2 - $Id$ */
public class X_EXME_Pre_Reclas_A extends PO implements I_EXME_Pre_Reclas_A, I_Persistent 
{
    ...
    public X_EXME_Pre_Reclas_A (Properties ctx, int EXME_Pre_Reclas_A_ID, String trxName)
    {
      super (ctx, EXME_Pre_Reclas_A_ID, trxName);
      /** if (EXME_Pre_Reclas_A_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_EXME_Pre_Reclas_A (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_Pre_Reclas_A[")
	...
	/** Set Pre reclasificacion.
		@param EXME_Pre_Reclas_A_ID Pre reclasificacion	  */
	public void setEXME_Pre_Reclas_A_ID (int EXME_Pre_Reclas_A_ID)
	{
		if (EXME_Pre_Reclas_A_ID < 1)
			 throw new IllegalArgumentException ("EXME_Pre_Reclas_A_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_EXME_Pre_Reclas_A_ID, Integer.valueOf(EXME_Pre_Reclas_A_ID));
	}

	/** Get Pre reclasificacion.
		@return Pre reclasificacion	  */
	public int getEXME_Pre_Reclas_A_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_EXME_Pre_Reclas_A_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
