...
// 1
	...
	/** Set Price Cost Package.
		@param PriceCost_Vol 
		Price Cost Package
	  */
	public void setPriceCost_Vol (BigDecimal PriceCost_Vol)
	{
		set_Value (COLUMNNAME_PriceCost_Vol, PriceCost_Vol);
	}

	/** Get Price Cost Package.
		@return Price Cost Package
	  */
	public BigDecimal getPriceCost_Vol () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_PriceCost_Vol);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Set Delivered Quantity Package.
		@param QtyDelivered_Vol 
		Delivered Quantity Package
	  */
	public void setQtyDelivered_Vol (BigDecimal QtyDelivered_Vol)
	{
		set_Value (COLUMNNAME_QtyDelivered_Vol, QtyDelivered_Vol);
	}

	/** Get Delivered Quantity Package.
		@return Delivered Quantity Package
	  */
	public BigDecimal getQtyDelivered_Vol () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_QtyDelivered_Vol);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
