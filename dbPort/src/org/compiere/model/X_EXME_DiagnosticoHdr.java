...
/** Generated Model for EXME_DiagnosticoHdr
 *  @author Generated Class 
 *  @version Release 1.2 - $Id$ */
public class X_EXME_DiagnosticoHdr extends PO implements I_EXME_DiagnosticoHdr, I_Persistent 
{
    ...
    public X_EXME_DiagnosticoHdr (Properties ctx, int EXME_DiagnosticoHdr_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_EXME_DiagnosticoHdr (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_DiagnosticoHdr[")
