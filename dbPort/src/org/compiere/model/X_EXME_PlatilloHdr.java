...
/** Generated Model for EXME_PlatilloHdr
 *  @author Generated Class 
 *  @version Release 1.2 - $Id$ */
public class X_EXME_PlatilloHdr extends PO implements I_EXME_PlatilloHdr, I_Persistent 
{
    ...
    public X_EXME_PlatilloHdr (Properties ctx, int EXME_PlatilloHdr_ID, String trxName)
    {
      super (ctx, EXME_PlatilloHdr_ID, trxName);
      /** if (EXME_PlatilloHdr_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_EXME_PlatilloHdr (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_PlatilloHdr[")
