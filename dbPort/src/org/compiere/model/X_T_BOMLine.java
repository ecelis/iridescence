...
public class X_T_BOMLine extends PO implements I_T_BOMLine, I_Persistent 
{
	...
	public org.compiere.model.I_PP_Product_BOMLine getPP_Product_BOMLine() throws RuntimeException 
    {
        Class<?> clazz = MTable.getClass(org.compiere.model.I_PP_Product_BOMLine.Table_Name);
        org.compiere.model.I_PP_Product_BOMLine result = null;
        try	{
	        Constructor<?> constructor = null;
	    	constructor = clazz.getDeclaredConstructor(new Class[]{Properties.class, int.class, String.class});
    	    result = (org.compiere.model.I_PP_Product_BOMLine)constructor.newInstance(new Object[] {getCtx(), new Integer(getPP_Product_BOMLine_ID()), get_TrxName()});
        } catch (Exception e) {
	        log.log(Level.SEVERE, "(id) - Table=" + Table_Name + ",Class=" + clazz, e);
	        log.saveError("Error", "Table=" + Table_Name + ",Class=" + clazz);
           throw new RuntimeException( e );
