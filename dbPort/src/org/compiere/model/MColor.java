...
public class MColor extends X_AD_Color
{
	...
	protected Object loadSpecial (ResultSet rs, int index) throws SQLException
	{
		...
		if (index == get_ColumnIndex("ColorType"))
			return DB.TO_STRING (rs.getString(index+1)); //Lama
		return null;
	}   //  loadSpecial
	...
	protected String saveNewSpecial (Object value, int index)
	{
		...
		if (value == null)
			return "NULL";
		return DB.TO_STRING (value.toString()); //Lama
	}   //  saveNewSpecial
	...
	public void Color2Hex ( int r, int g , int b ) {
		Color c = new Color(r,g,b);
		setColorHex(String.valueOf(Integer.toHexString( c.getRGB() & 0x00ffffff ) )); 
	}
}   //  MColor
