...
/** Generated Model for EXME_T_Cierre
 *  @author Generated Class 
 *  @version Release 1.2 - $Id$ */
public class X_EXME_T_Cierre extends PO implements I_EXME_T_Cierre, I_Persistent 
{
    ...
    public X_EXME_T_Cierre (Properties ctx, int EXME_T_Cierre_ID, String trxName)
    {
      super (ctx, EXME_T_Cierre_ID, trxName);
      /** if (EXME_T_Cierre_ID == 0)
        {
			setAccount_ID (0);
			...
			setEXME_T_Cierre_ID (0);
        } */
    }

    /** Load Constructor */
    public X_EXME_T_Cierre (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_T_Cierre[")
	...
	/** Set Closure.
		@param EXME_T_Cierre_ID Closure	  */
	public void setEXME_T_Cierre_ID (int EXME_T_Cierre_ID)
	{
		if (EXME_T_Cierre_ID < 1)
			 throw new IllegalArgumentException ("EXME_T_Cierre_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_EXME_T_Cierre_ID, Integer.valueOf(EXME_T_Cierre_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_EXME_T_Cierre_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
