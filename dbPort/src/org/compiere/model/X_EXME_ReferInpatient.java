...
/** Generated Model for EXME_ReferInpatient
 *  @author Generated Class 
 *  @version Version @VERSION@ - $Id$ */
public class X_EXME_ReferInpatient extends PO implements I_EXME_ReferInpatient, I_Persistent 
{
    ...
    public X_EXME_ReferInpatient (Properties ctx, int EXME_ReferInpatient_ID, String trxName)
    {
      super (ctx, EXME_ReferInpatient_ID, trxName);
      /** if (EXME_ReferInpatient_ID == 0)
        {
			setEXME_Paciente_ID (0);
			setEXME_ReferInpatient_ID (0);
        } */
    }

    /** Load Constructor */
    public X_EXME_ReferInpatient (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_ReferInpatient[")
	...
	/** Set Target Encounter.
		@param EXME_CtaPacDest_ID 
		The encounter created from the reference
	  */
	public void setEXME_CtaPacDest_ID (int EXME_CtaPacDest_ID)
	{
		if (EXME_CtaPacDest_ID < 1) 
			set_Value (COLUMNNAME_EXME_CtaPacDest_ID, null);
		else 
			set_Value (COLUMNNAME_EXME_CtaPacDest_ID, Integer.valueOf(EXME_CtaPacDest_ID));
	}

	/** Get Target Encounter.
		@return The encounter created from the reference
	  */
	public int getEXME_CtaPacDest_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_EXME_CtaPacDest_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	public void setEXME_ReferInpatient_ID (int EXME_ReferInpatient_ID)
	{
		if (EXME_ReferInpatient_ID < 1)
			 throw new IllegalArgumentException ("EXME_ReferInpatient_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_EXME_ReferInpatient_ID, Integer.valueOf(EXME_ReferInpatient_ID));
	}
