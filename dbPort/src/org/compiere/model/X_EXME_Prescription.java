...
/** Generated Model for EXME_Prescription
 *  @author Generated Class 
 *  @version Release 1.1.2 - $Id$ */
public class X_EXME_Prescription extends PO implements I_EXME_Prescription, I_Persistent 
{
    ...
    public X_EXME_Prescription (Properties ctx, int EXME_Prescription_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_EXME_Prescription (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_Prescription[")
	...
	/** Set Dosificacion.
		@param Dosificacion Dosificacion	  */
	public void setDosificacion (String Dosificacion)
	{
		set_Value (COLUMNNAME_Dosificacion, Dosificacion);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_Dosificacion);
	}
	...
	public void setEXME_Prescription_ID (int EXME_Prescription_ID)
	{
		if (EXME_Prescription_ID < 1)
			 throw new IllegalArgumentException ("EXME_Prescription_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_EXME_Prescription_ID, Integer.valueOf(EXME_Prescription_ID));
	}
	...
	/** Set Prescription Reference.
		@param Ref_Prescription_ID Prescription Reference	  */
	public void setRef_Prescription_ID (int Ref_Prescription_ID)
	{
		if (Ref_Prescription_ID < 1) 
			set_Value (COLUMNNAME_Ref_Prescription_ID, null);
		else 
			set_Value (COLUMNNAME_Ref_Prescription_ID, Integer.valueOf(Ref_Prescription_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Ref_Prescription_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
