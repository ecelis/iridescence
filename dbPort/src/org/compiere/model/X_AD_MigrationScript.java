...
public class X_AD_MigrationScript extends PO implements I_AD_MigrationScript, I_Persistent 
{
	...
	/** Status AD_Reference_ID=1200262 */
	public static final int STATUS_AD_Reference_ID=1200262;
	/** In Progress = IP */
	...
	public void setStatus (String Status)
	{
		...
		if (Status.equals("IP") || Status.equals("CO") || Status.equals("ER")); else throw new IllegalArgumentException ("Status Invalid value - " + Status + " - Reference_ID=1200262 - IP - CO - ER");		set_ValueNoCheck (COLUMNNAME_Status, Status);
	}
