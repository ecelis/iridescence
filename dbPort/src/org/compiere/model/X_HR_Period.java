...
public class X_HR_Period extends PO implements I_HR_Period, I_Persistent 
{
	...
	public org.compiere.model.I_HR_Year getHR_Year() throws RuntimeException 
    {
        Class<?> clazz = MTable.getClass(org.compiere.model.I_HR_Year.Table_Name);
        org.compiere.model.I_HR_Year result = null;
        try	{
	        Constructor<?> constructor = null;
	    	constructor = clazz.getDeclaredConstructor(new Class[]{Properties.class, int.class, String.class});
    	    result = (org.compiere.model.I_HR_Year)constructor.newInstance(new Object[] {getCtx(), new Integer(getHR_Year_ID()), get_TrxName()});
        } catch (Exception e) {
	        log.log(Level.SEVERE, "(id) - Table=" + Table_Name + ",Class=" + clazz, e);
	        log.saveError("Error", "Table=" + Table_Name + ",Class=" + clazz);
           throw new RuntimeException( e );
