...
public class DB_Oracle implements CompiereDatabase
{
	...
	public String getStatus() {
		...
		try {
        	...
        	sb.append("Exception on getStatus() : " + e.getMessage());
        }
...
//				//
//				ds.setDataSourceName("eCareSoftDS");
//				ds.setDescription("eCareSoft Oracle Data Source");
...
//				m_ds = (DataSource) ic.lookup( "java:/eCareSoftDS" );
...
//				InitialContext ic;
//				ic = new InitialContext();
//				cpds = (ComboPooledDataSource) ic.lookup("eCareSoftDS" );
	...
	throws Exception
	{
		...
		try
		{
			if (conn != null) {
				...
				/** Monitoreo del estatus de las conexiones */
				log.fine("****** Connection monitoring : " + getStatus());
			...
			boolean defaultValue)
	{
		...
		if (retValue == null)
		{
			...
			case DisplayType.Employment: //Expert: Lama
			retValue = "NUMBER(10)";
			break;
