...
/** Generated Model for EXME_IntervencionHdr_TRL
 *  @author Generated Class 
 *  @version Release 5.5 - $Id$ */
public class X_EXME_IntervencionHdr_TRL extends PO implements I_EXME_IntervencionHdr_TRL, I_Persistent 
{
    ...
    public X_EXME_IntervencionHdr_TRL (Properties ctx, int EXME_IntervencionHdr_TRL_ID, String trxName)
    {
      super (ctx, EXME_IntervencionHdr_TRL_ID, trxName);
      /** if (EXME_IntervencionHdr_TRL_ID == 0)
        {
			setAD_Language (null);
			setEXME_IntervencionHdr_ID (0);
// @EXME_IntervencionHdr_ID@
			setName (null);
			setValue (null);
        } */
    }
    ...
    /** Load Constructor */
    public X_EXME_IntervencionHdr_TRL (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_IntervencionHdr_TRL[")
