...
/** Generated Model for EXME_PacMedicamento
 *  @author Generated Class 
 *  @version Release 1.2 - $Id$ */
public class X_EXME_PacMedicamento extends PO implements I_EXME_PacMedicamento, I_Persistent 
{
    ...
    public X_EXME_PacMedicamento (Properties ctx, int EXME_PacMedicamento_ID, String trxName)
    {
      super (ctx, EXME_PacMedicamento_ID, trxName);
      /** if (EXME_PacMedicamento_ID == 0)
        {
			setEXME_Paciente_ID (0);
			setEXME_PacMedicamento_ID (0);
			setName (null);
    ...
    /** Load Constructor */
    public X_EXME_PacMedicamento (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_PacMedicamento[")
	...
	/** Set Patient Medication.
		@param EXME_PacMedicamento_ID Patient Medication	  */
	public void setEXME_PacMedicamento_ID (int EXME_PacMedicamento_ID)
	{
		if (EXME_PacMedicamento_ID < 1)
			 throw new IllegalArgumentException ("EXME_PacMedicamento_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_EXME_PacMedicamento_ID, Integer.valueOf(EXME_PacMedicamento_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_EXME_PacMedicamento_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
