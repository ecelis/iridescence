...
public class ModelClassGenerator
{
	...
	private String createHeader (int AD_Table_ID, StringBuffer sb, StringBuffer mandatory, String packageName)
	{
		...
		start.append("/** Generated Model for ").append(tableName).append(NL)
			 .append(" *  @author Generated Class ").append(NL)
			 .append(" *  @version ").append(Compiere.MAIN_VERSION).append(" - $Id$ */").append(NL)
...
//		Boolean
		...
		String columnName, boolean nullable)
	{
		...
		//
		String sql = "SELECT Value, ItemName FROM AD_Ref_List WHERE AD_Reference_ID=? ORDER BY AD_Ref_List_ID";
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		try
		{
