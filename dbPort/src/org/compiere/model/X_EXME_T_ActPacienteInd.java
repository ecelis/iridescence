...
/** Generated Model for EXME_T_ActPacienteInd
 *  @author Generated Class 
 *  @version Release 1.2 - $Id$ */
public class X_EXME_T_ActPacienteInd extends PO implements I_EXME_T_ActPacienteInd, I_Persistent 
{
    ...
    public X_EXME_T_ActPacienteInd (Properties ctx, int EXME_T_ActPacienteInd_ID, String trxName)
    {
      super (ctx, EXME_T_ActPacienteInd_ID, trxName);
      /** if (EXME_T_ActPacienteInd_ID == 0)
        {
			setAlergic (false);
...
// -1
    ...
    /** Load Constructor */
    public X_EXME_T_ActPacienteInd (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_T_ActPacienteInd[")
	...
	/** Set is Alergic.
		@param Alergic 
		Indicates if the patient is alergic to an expecific product
	  */
	public void setAlergic (boolean Alergic)
	{
		set_Value (COLUMNNAME_Alergic, Boolean.valueOf(Alergic));
	}

	/** Get is Alergic.
		@return Indicates if the patient is alergic to an expecific product
	  */
	public boolean isAlergic () 
	{
		Object oo = get_Value(COLUMNNAME_Alergic);
		if (oo != null) 
		{
	...
	{
		throw new IllegalArgumentException ("CitaNo is virtual column");	}
	...
	public void setEstatus (String Estatus)
	{
		...
		if (Estatus == null || Estatus.equals("S") || Estatus.equals("P") || Estatus.equals("C") || Estatus.equals("A")); else throw new IllegalArgumentException ("Estatus Invalid value - " + Estatus + " - Reference_ID=1200114 - S - P - C - A");		set_Value (COLUMNNAME_Estatus, Estatus);
	}
	...
	/** Set Patient's Activity.
		@param EXME_T_ActPacienteInd_ID Patient's Activity	  */
	public void setEXME_T_ActPacienteInd_ID (int EXME_T_ActPacienteInd_ID)
	{
		if (EXME_T_ActPacienteInd_ID < 1)
			 throw new IllegalArgumentException ("EXME_T_ActPacienteInd_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_EXME_T_ActPacienteInd_ID, Integer.valueOf(EXME_T_ActPacienteInd_ID));
	}

	/** Get Patient's Activity.
		@return Patient's Activity	  */
	public int getEXME_T_ActPacienteInd_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_EXME_T_ActPacienteInd_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	public I_EXME_Tratamientos_Productos getEXME_Tratamientos_Productos() throws RuntimeException 
    {
        Class<?> clazz = MTable.getClass(I_EXME_Tratamientos_Productos.Table_Name);
        I_EXME_Tratamientos_Productos result = null;
        try	{
	        Constructor<?> constructor = null;
	    	constructor = clazz.getDeclaredConstructor(new Class[]{Properties.class, int.class, String.class});
    	    result = (I_EXME_Tratamientos_Productos)constructor.newInstance(new Object[] {getCtx(), new Integer(getEXME_Tratamientos_Productos_ID()), get_TrxName()});
        } catch (Exception e) {
	        log.log(Level.SEVERE, "(id) - Table=" + Table_Name + ",Class=" + clazz, e);
	        log.saveError("Error", "Table=" + Table_Name + ",Class=" + clazz);
           throw new RuntimeException( e );
	...
	public void setEXME_Tratamientos_Productos_ID (int EXME_Tratamientos_Productos_ID)
	{
		if (EXME_Tratamientos_Productos_ID < 1) 
			set_Value (COLUMNNAME_EXME_Tratamientos_Productos_ID, null);
		else 
			set_Value (COLUMNNAME_EXME_Tratamientos_Productos_ID, Integer.valueOf(EXME_Tratamientos_Productos_ID));
	}
	...
	{
		return (String)get_Value(COLUMNNAME_GuaranteeDate);
	}
