 ...
 *
 *  @author     Jorg Janke
 *  @version    $Id: OnlineHelp.java,v 1.4 2006/08/23 00:33:36 mrojas Exp $
 */
public class OnlineHelp extends JEditorPane implements HyperlinkListener
{
	...
	protected static final String   BASE_URL = "http://www.expert.com.mx"; //EXPERT: mrojas
	...
	protected void displayError (String header, Object url, Object exception)
	{
		...
		msg.append("<H1>").append(header).append("</H1>")
			...
			/* EXPERT: mrojas */
			.append("<p>&copy;&nbsp;Expert Sistemas Computacionales, S. A. de C. V. &nbsp; ")
			.append("<A HREF=\"").append(BASE_URL).append ("\">Ayuda en linea</A></p>")
			/* EXPERT: mrojas */
			.append("</BODY></HTML>");
