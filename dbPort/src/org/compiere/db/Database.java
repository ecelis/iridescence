...
public class Database
{
	 ...
	 *  @return database
	 */
	public static CompiereDatabase getDatabase (String type)
	throws Exception
	{
		CompiereDatabase db = null;
		for (int i = 0; i < Database.DB_NAMES.length; i++)
		{
			if (Database.DB_NAMES[i].equals (type))
			{
				db = (CompiereDatabase)Database.DB_CLASSES[i].
				newInstance ();
				break;
			}
		}
	 ...
	 */
	public static CompiereDatabase getDatabaseFromURL(String url)
	{
		if (url == null)
		{
