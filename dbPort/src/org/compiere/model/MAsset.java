...
public class MAsset extends X_A_Asset
{
	 ...
	 * @return retorno Regresa true si no existe un registro con el M_Product_ID igual al parametro productId
	 */
	public static boolean isNew(int productId, String trxName){
		boolean retorno = true;
		StringBuilder sql = new StringBuilder()
		.append("SELECT * FROM A_Asset ")
