...
/** Generated Model for EXME_CancelCharges
 *  @author Generated Class 
 *  @version Version @VERSION@ - $Id$ */
public class X_EXME_CancelCharges extends PO implements I_EXME_CancelCharges, I_Persistent 
{
    ...
    public X_EXME_CancelCharges (Properties ctx, int EXME_CancelCharges_ID, String trxName)
    {
      super (ctx, EXME_CancelCharges_ID, trxName);
      /** if (EXME_CancelCharges_ID == 0)
        {
			setDateCanceled (new Timestamp( System.currentTimeMillis() ));
			setDate_Created (new Timestamp( System.currentTimeMillis() ));
			setExme_CancelCharges_ID (0);
			setQty (Env.ZERO);
        } */
    }

    /** Load Constructor */
    public X_EXME_CancelCharges (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_CancelCharges[")
	...
	public void setDateCanceled (Timestamp DateCanceled)
	{
		if (DateCanceled == null)
			throw new IllegalArgumentException ("DateCanceled is mandatory.");
	...
	public void setDate_Created (Timestamp Date_Created)
	{
		...
		set_Value (COLUMNNAME_Date_Created, Date_Created);
	}
	...
	public void setExme_CancelCharges_ID (int Exme_CancelCharges_ID)
	{
		if (Exme_CancelCharges_ID < 1)
			 throw new IllegalArgumentException ("Exme_CancelCharges_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_Exme_CancelCharges_ID, Integer.valueOf(Exme_CancelCharges_ID));
	}
