...
public class UserPassword extends SvrProcess
{
	...
	protected String doIt() throws Exception
	{
		...
		else if (!org.compiere.util.UtilsDbPort.encrypt(p_OldPassword).equals(user.getPassword()))
		...
		if (p_AD_User_ID == 0)
		{
			...
			if (!Util.isEmpty(p_NewPassword))
				sql += ", Password=" + DB.TO_STRING(org.compiere.util.UtilsDbPort.encrypt(p_NewPassword));
