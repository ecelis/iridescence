...
/** Generated Model for DH_PrePayment
 *  @author Generated Class 
 *  @version Version @VERSION@ - $Id$ */
public class X_DH_PrePayment extends PO implements I_DH_PrePayment, I_Persistent 
{
    ...
    public X_DH_PrePayment (Properties ctx, int DH_PrePayment_ID, String trxName)
    {
      super (ctx, DH_PrePayment_ID, trxName);
      /** if (DH_PrePayment_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_DH_PrePayment (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_DH_PrePayment[")
	...
	public void setDH_PrePayment_ID (int DH_PrePayment_ID)
	{
		...
		set_ValueNoCheck (COLUMNNAME_DH_PrePayment_ID, Integer.valueOf(DH_PrePayment_ID));
	}
