...
public class MAccount extends X_C_ValidCombination
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 730163760053886659L;
	...
	public String getNamePrint(){
		...
		if(getAlias()==null || getAlias().isEmpty()){
			name.append(getDescription()==null || getDescription().isEmpty()?"":getDescription()).append(" ");
			name.append(getCombination()==null || getCombination().isEmpty()?"":getCombination());
			
		} else {
			name.append(getAlias()).append(" ");
			name.append(getDescription()==null || getDescription().isEmpty()?"":getDescription()).append(" ");
			name.append(getCombination()==null || getCombination().isEmpty()?"":getCombination());
		}
