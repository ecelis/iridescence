...
/** Generated Model for EXME_CtaPacTax
 *  @author Generated Class 
 *  @version Release 1.2 - $Id$ */
public class X_EXME_CtaPacTax extends PO implements I_EXME_CtaPacTax, I_Persistent 
{
    ...
    public X_EXME_CtaPacTax (Properties ctx, int EXME_CtaPacTax_ID, String trxName)
    {
      super (ctx, EXME_CtaPacTax_ID, trxName);
      /** if (EXME_CtaPacTax_ID == 0)
        {
			setC_Tax_ID (0);
    ...
    /** Load Constructor */
    public X_EXME_CtaPacTax (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_CtaPacTax[")
