...
public class X_A_Asset_Change extends PO implements I_A_Asset_Change, I_Persistent 
{
	...
	/** A_Depreciation_Manual_Period AD_Reference_ID=1200303 */
	public static final int A_DEPRECIATION_MANUAL_PERIOD_AD_Reference_ID=1200303;
	/** Period = PR */
	...
	public void setA_Reval_Cal_Method (String A_Reval_Cal_Method)
	{
		...
		if (A_Reval_Cal_Method == null || A_Reval_Cal_Method.equals("DFT") || A_Reval_Cal_Method.equals("IDF") || A_Reval_Cal_Method.equals("YBF")); else throw new IllegalArgumentException ("A_Reval_Cal_Method Invalid value - " + A_Reval_Cal_Method + " - Reference_ID=1200306 - DFT - IDF - YBF");		set_Value (COLUMNNAME_A_Reval_Cal_Method, A_Reval_Cal_Method);
	}
	...
	/** ChangeType AD_Reference_ID=1200320 */
	public static final int CHANGETYPE_AD_Reference_ID=1200320;
	/** Addition = ADD */
	...
	public void setChangeType (String ChangeType)
	{
		...
		if (ChangeType.equals("ADD") || ChangeType.equals("BAL") || ChangeType.equals("CRT") || ChangeType.equals("DEP") || ChangeType.equals("DIS") || ChangeType.equals("EXP") || ChangeType.equals("FOR") || ChangeType.equals("IMP") || ChangeType.equals("RVL") || ChangeType.equals("SET") || ChangeType.equals("SPL") || ChangeType.equals("TRN") || ChangeType.equals("UPD") || ChangeType.equals("USE")); else throw new IllegalArgumentException ("ChangeType Invalid value - " + ChangeType + " - Reference_ID=1200320 - ADD - BAL - CRT - DEP - DIS - EXP - FOR - IMP - RVL - SET - SPL - TRN - UPD - USE");		set_ValueNoCheck (COLUMNNAME_ChangeType, ChangeType);
	}
