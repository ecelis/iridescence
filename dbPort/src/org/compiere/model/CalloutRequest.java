...
public class CalloutRequest extends CalloutEngine
{
	...
	public String copyMail (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value)
	{
		...
		Integer R_MailText_ID = null;
		if(value instanceof BigDecimal)
			R_MailText_ID = Integer.valueOf(value.toString());
		else if(value instanceof Integer)
			R_MailText_ID = (Integer)value;
		
		if (R_MailText_ID == null || R_MailText_ID.intValue() == 0)
			return "";
	...
	public String copyResponse (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value)
	{
		...
		Integer R_StandardResponse_ID = null;
		if(value instanceof BigDecimal)
			R_StandardResponse_ID = Integer.valueOf(value.toString());
		else if(value instanceof Integer)
			R_StandardResponse_ID = (Integer)value;
		
		if (R_StandardResponse_ID == null || R_StandardResponse_ID.intValue() == 0)
			return "";
	...
	public String type (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value)
	{
		...
		if(value instanceof BigDecimal)
			R_RequestType_ID = Integer.valueOf(value.toString());
		else if(value instanceof Integer)
			R_RequestType_ID = ((Integer)value).intValue();
