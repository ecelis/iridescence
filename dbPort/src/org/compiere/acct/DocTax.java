...
public final class DocTax
{
	...
	/** Tax Due Acct        */
	public static final int    ACCTTYPE_TaxDue = 0;// Impuesto por pagar
	/** Tax Liability       */
	public static final int    ACCTTYPE_TaxLiability = 1;// Impuesto a cargo
	/** Tax Credit          */
	public static final int    ACCTTYPE_TaxCredit = 2;// Impuesto por recuperar
	/** Tax Receivables     */
	public static final int    ACCTTYPE_TaxReceivables = 3;// Impuesto a favor
	/** Tax Expense         */
	public static final int    ACCTTYPE_TaxExpense = 4;// Gastos por impuesto
	...
	public MAccount getAccount (int AcctType, MAcctSchema as)
	{
		...
		return MTax.getAccount ( AcctType,  as,  m_C_Tax_ID);
	}
...
*/
	...
	/**
	 * 	Get AR Tax Type
	 *	@return AR tax type (Credit or Expense) 
	 */
	public int getARTaxTypeBank(final boolean isDR)
	{
		if (isDR)
			return ACCTTYPE_TaxDue;//por pagar
		return ACCTTYPE_TaxLiability;//a cargo (trasladado)
	}	//	
	
	/**
	 * 	Get AP Tax Type
	 *	@return AP tax type (x pagar ó a cargo) 
	 */
	public int getAPTaxTypeBank(final boolean isDR)
	{
		if (isDR)
			return ACCTTYPE_TaxCredit;// por recuperar (acreditar)
		return ACCTTYPE_TaxReceivables; // a favor (acreditable)
	}	//	
