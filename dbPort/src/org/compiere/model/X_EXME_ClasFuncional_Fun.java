...
/** Generated Model for EXME_ClasFuncional_Fun
 *  @author Generated Class 
 *  @version Version @VERSION@ - $Id$ */
public class X_EXME_ClasFuncional_Fun extends PO implements I_EXME_ClasFuncional_Fun, I_Persistent 
{
    ...
    public X_EXME_ClasFuncional_Fun (Properties ctx, int EXME_ClasFuncional_Fun_ID, String trxName)
    {
      super (ctx, EXME_ClasFuncional_Fun_ID, trxName);
      /** if (EXME_ClasFuncional_Fun_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_EXME_ClasFuncional_Fun (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_ClasFuncional_Fun[")
	...
	public void setEXME_ClasFuncional_Fun_ID (int EXME_ClasFuncional_Fun_ID)
	{
		...
		set_ValueNoCheck (COLUMNNAME_EXME_ClasFuncional_Fun_ID, Integer.valueOf(EXME_ClasFuncional_Fun_ID));
	}
