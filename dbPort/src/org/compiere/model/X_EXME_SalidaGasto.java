...
/** Generated Model for EXME_SalidaGasto
 *  @author Generated Class 
 *  @version Version @VERSION@ - $Id$ */
public class X_EXME_SalidaGasto extends PO implements I_EXME_SalidaGasto, I_Persistent 
{
    ...
    public X_EXME_SalidaGasto (Properties ctx, int EXME_SalidaGasto_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_EXME_SalidaGasto (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_SalidaGasto[")
	...
	/** Set Area / Specific Department .
		@param AreaDepto Area / Specific Department 	  */
	public void setAreaDepto (String AreaDepto)
	{
		set_Value (COLUMNNAME_AreaDepto, AreaDepto);
	}

	/** Get Area / Specific Department .
		@return Area / Specific Department 	  */
	public String getAreaDepto () 
	{
		return (String)get_Value(COLUMNNAME_AreaDepto);
	}
	...
	public void setEXME_SalidaGasto_ID (int EXME_SalidaGasto_ID)
	{
		...
		set_ValueNoCheck (COLUMNNAME_EXME_SalidaGasto_ID, Integer.valueOf(EXME_SalidaGasto_ID));
	}
	...
	{
		set_Value (COLUMNNAME_Extension, Integer.valueOf(Extension));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Extension);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	{
		set_Value (COLUMNNAME_GenerateList, Boolean.valueOf(GenerateList));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_GenerateList);
		if (oo != null) 
		{
