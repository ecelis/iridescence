...
public class MUserOrgAccess extends X_AD_User_OrgAccess
{
	...
	/**
	 * Gets the organizations in the specified client that the user has access
	 * to. It takes client and user from the application context.
	 * @param ctx The application context.
	 * @return An array with the organization ids.
	 */
	public static Integer[] getAccessForUserClient(Properties ctx) {
		List<Integer> list = new ArrayList<Integer>();
		Integer[] retVal = null;
		String sql =
				"SELECT AD_Org_ID FROM AD_User_OrgAccess WHERE AD_Client_ID = ? AND AD_User_ID = ?";
		PreparedStatement pstmt = null;
		ResultSet rs = null;
