...
/** Generated Model for EXME_LogMedicalDecision
 *  @author Generated Class 
 *  @version Version @VERSION@ - $Id$ */
public class X_EXME_LogMedicalDecision extends PO implements I_EXME_LogMedicalDecision, I_Persistent 
{
    ...
    public X_EXME_LogMedicalDecision (Properties ctx, int EXME_LogMedicalDecision_ID, String trxName)
    {
      super (ctx, EXME_LogMedicalDecision_ID, trxName);
      /** if (EXME_LogMedicalDecision_ID == 0)
        {
			setEXME_LogMedicalDecision_ID (0);
			setReviewed (false);
        } */
    }

    /** Load Constructor */
    public X_EXME_LogMedicalDecision (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_LogMedicalDecision[")
	...
	/** Set Medical Decision.
		@param EXME_LogMedicalDecision_ID Medical Decision	  */
	public void setEXME_LogMedicalDecision_ID (int EXME_LogMedicalDecision_ID)
	{
		if (EXME_LogMedicalDecision_ID < 1)
			 throw new IllegalArgumentException ("EXME_LogMedicalDecision_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_EXME_LogMedicalDecision_ID, Integer.valueOf(EXME_LogMedicalDecision_ID));
	}

	/** Get Medical Decision.
		@return Medical Decision	  */
	public int getEXME_LogMedicalDecision_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_EXME_LogMedicalDecision_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set Medical Comment.
		@param MedicalComment Medical Comment	  */
	public void setMedicalComment (String MedicalComment)
	{
		set_Value (COLUMNNAME_MedicalComment, MedicalComment);
	}

	/** Get Medical Comment.
		@return Medical Comment	  */
	public String getMedicalComment () 
	{
		return (String)get_Value(COLUMNNAME_MedicalComment);
	}
	...
	{
		set_Value (COLUMNNAME_Reviewed, Boolean.valueOf(Reviewed));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_Reviewed);
		if (oo != null) 
		{
