...
public abstract class SvrProcess implements ProcessCall
{
	...
	/** Resultado del proceso ejecutado */
	...
	public void setCtx(final Properties mctx) {
		this.m_ctx = mctx;
	}
	/**
	 *  Get Name/Title
	...
	protected ProcessInfoParameter[] getParameter()
	{
		...
		//rsolorzano los par#metros se llenan siempre en caso de que se haya seleccionado la 
		//opci#n de regresar en la pantalla
		ProcessInfoParameter[] retValue = null;
		ProcessInfoUtil.setParameterFromDB(m_pi);
		retValue = m_pi.getParameter();
