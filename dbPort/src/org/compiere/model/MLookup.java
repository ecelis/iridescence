 ...
 *  </pre>
 * 	@author 	Jorg Janke
 * 	@version 	$Id: MLookup.java,v 1.2 2006/07/30 00:54:54 jjanke Exp $
 */
public final class MLookup extends Lookup implements Serializable
{
	...
	private static final int	MAX_ROWS = 10000;		//	i.e. Drop Down has max 500 items
	/**	Indicator for Null			*/
	...
	public NamePair get (Object key)
	{
		...
		//auto refresh parent lookup : expert : mrojas : integracion zk
		if (m_info.IsParent )
		{
	...
	public NamePair getDirect (Object key, boolean saveInCache, boolean cacheLocal)
	{
		...
		catch (Exception e)
		{
			...
			try {
				...
				log.log(Level.SEVERE, "getDirect - while closing rs and pstmt", e);
			}
		}
