...
/** Generated Model for EXME_Ejecucion_Cuest
 *  @author Generated Class 
 *  @version Version @VERSION@ - $Id$ */
public class X_EXME_Ejecucion_Cuest extends PO implements I_EXME_Ejecucion_Cuest, I_Persistent 
{
    ...
    public X_EXME_Ejecucion_Cuest (Properties ctx, int EXME_Ejecucion_Cuest_ID, String trxName)
    {
      super (ctx, EXME_Ejecucion_Cuest_ID, trxName);
      /** if (EXME_Ejecucion_Cuest_ID == 0)
        {
			setAD_Table_ID (0);
			setDocAction (null);
			setDocStatus (null);
    ...
    /** Load Constructor */
    public X_EXME_Ejecucion_Cuest (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_Ejecucion_Cuest[")
	...
	public void setEXME_Ejecucion_Cuest_ID (int EXME_Ejecucion_Cuest_ID)
	{
		if (EXME_Ejecucion_Cuest_ID < 1)
			 throw new IllegalArgumentException ("EXME_Ejecucion_Cuest_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_EXME_Ejecucion_Cuest_ID, Integer.valueOf(EXME_Ejecucion_Cuest_ID));
	}
