...
public class MProcessPara extends X_AD_Process_Para
{
	...
	public boolean isLookup()
	{
		...
		if (DisplayType.isLookup(displayType))
			...
			|| displayType == DisplayType.Employment //Expert:Lama
			)
			retValue = true;
		return retValue;
	}   //  isLookup
	...
	public void loadLookup()
	{
		...
		else if (displayType == DisplayType.Employment) {  //  not cached
			MEmploymentLookup ml = new MEmploymentLookup (getCtx(), WINDOW_NO);
			m_lookup = ml;
		}
		//
		if (m_lookup != null)
