...
public class X_HR_ListLine extends PO implements I_HR_ListLine, I_Persistent 
{
	...
	public org.compiere.model.I_HR_ListVersion getHR_ListVersion() throws RuntimeException 
    {
        Class<?> clazz = MTable.getClass(org.compiere.model.I_HR_ListVersion.Table_Name);
        org.compiere.model.I_HR_ListVersion result = null;
        try	{
	        Constructor<?> constructor = null;
	    	constructor = clazz.getDeclaredConstructor(new Class[]{Properties.class, int.class, String.class});
    	    result = (org.compiere.model.I_HR_ListVersion)constructor.newInstance(new Object[] {getCtx(), new Integer(getHR_ListVersion_ID()), get_TrxName()});
        } catch (Exception e) {
