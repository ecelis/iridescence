...
public class InfoOrder extends Info
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5527578226699559495L;
	...
	String getSQLWhere()
	{
		...
		if (fDateFrom.getValue() != null || fDateTo.getValue() != null)
		{
			...
			if (DB.isOracle()) {
				...
				if (from == null && to != null)
					sql.append(" AND DATE_TRUNC('day', o.DateOrdered) <= ?");
				else if (from != null && to == null)
					sql.append(" AND DATE_TRUNC('day', o.DateOrdered) >= ?");
				else if (from != null && to != null)
					sql.append(" AND DATE_TRUNC('day', o.DateOrdered) BETWEEN ? AND ?");
			}
		}
		//
