...
public class MClickCount extends X_W_ClickCount {
	...
	private SimpleDateFormat m_dateFormat = DisplayType
			.getDateFormat(DisplayType.Date);
	private DecimalFormat m_intFormat = DisplayType
	 ...
	 * 
	 * @param DateFormat
	 *            valid TRUNC date format
	 * @return count
	 * @deprecated No se usa aunque tiene 3 referencias en esta misma clase.
	 *             Estas no se usan ni se llama. No se corrige lo del TRUNC para
	 *             Postgresql. Alejandro Garza.
	 */
	protected ValueNamePair[] getCount(String DateFormat) {
		ArrayList<ValueNamePair> list = new ArrayList<ValueNamePair>();
		String sql = "SELECT TRUNC(Created, '" + DateFormat + "'), Count(*) "
				+ "FROM W_Click " + "WHERE W_ClickCount_ID=? "
	 ...
	 * @deprecated No se usa por no tener referencias. No se corrige lo del
	 *             TRUNC para Postgresql. Alejandro Garza.
	 */
	 ...
	 * 
	 * @return weekly count
	 * @deprecated No se usa aunque tiene una referencia en
	 *             MAdvertisement.getClickCountWeek. Este no se llama. No se
	 *             corrige lo del TRUNC para Postgresql. Alejandro Garza.
	 */
