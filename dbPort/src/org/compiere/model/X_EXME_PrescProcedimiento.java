...
/** Generated Model for EXME_PrescProcedimiento
 *  @author Generated Class 
 *  @version Release 1.2 - $Id$ */
public class X_EXME_PrescProcedimiento extends PO implements I_EXME_PrescProcedimiento, I_Persistent 
{
    ...
    public X_EXME_PrescProcedimiento (Properties ctx, int EXME_PrescProcedimiento_ID, String trxName)
    {
      super (ctx, EXME_PrescProcedimiento_ID, trxName);
      /** if (EXME_PrescProcedimiento_ID == 0)
        {
			setEXME_CtaPac_ID (0);
			setEXME_Enfermeria_ID (0);
			setEXME_PrescProcedimiento_ID (0);
			setEXME_ProcEnfermeria_ID (0);
        } */
    }

    /** Load Constructor */
    public X_EXME_PrescProcedimiento (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_PrescProcedimiento[")
	...
	/** Set Procedure Prescription.
		@param EXME_PrescProcedimiento_ID Procedure Prescription	  */
	public void setEXME_PrescProcedimiento_ID (int EXME_PrescProcedimiento_ID)
	{
		if (EXME_PrescProcedimiento_ID < 1)
			 throw new IllegalArgumentException ("EXME_PrescProcedimiento_ID is mandatory.");
		set_ValueNoCheck (COLUMNNAME_EXME_PrescProcedimiento_ID, Integer.valueOf(EXME_PrescProcedimiento_ID));
	}

	/** Get Procedure Prescription.
		@return Procedure Prescription	  */
	public int getEXME_PrescProcedimiento_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_EXME_PrescProcedimiento_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
    ...
    {
        Class<?> clazz = MTable.getClass(I_EXME_ProcEnfermeria.Table_Name);
        I_EXME_ProcEnfermeria result = null;
        try	{
	        Constructor<?> constructor = null;
	    	constructor = clazz.getDeclaredConstructor(new Class[]{Properties.class, int.class, String.class});
    	    result = (I_EXME_ProcEnfermeria)constructor.newInstance(new Object[] {getCtx(), new Integer(getEXME_ProcEnfermeria_ID()), get_TrxName()});
        } catch (Exception e) {
	        log.log(Level.SEVERE, "(id) - Table=" + Table_Name + ",Class=" + clazz, e);
	        log.saveError("Error", "Table=" + Table_Name + ",Class=" + clazz);
           throw new RuntimeException( e );
	...
	public void setEXME_ProcEnfermeria_ID (int EXME_ProcEnfermeria_ID)
	{
		...
		set_Value (COLUMNNAME_EXME_ProcEnfermeria_ID, Integer.valueOf(EXME_ProcEnfermeria_ID));
	}
