...
/** Generated Model for EXME_TramiteHdr
 *  @author Generated Class 
 *  @version Release 1.2 - $Id$ */
public class X_EXME_TramiteHdr extends PO implements I_EXME_TramiteHdr, I_Persistent 
{
    ...
    public X_EXME_TramiteHdr (Properties ctx, int EXME_TramiteHdr_ID, String trxName)
    {
      super (ctx, EXME_TramiteHdr_ID, trxName);
      /** if (EXME_TramiteHdr_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_EXME_TramiteHdr (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_EXME_TramiteHdr[")
