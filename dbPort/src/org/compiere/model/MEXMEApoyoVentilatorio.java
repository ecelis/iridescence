 ...
 *
 */
public class MEXMEApoyoVentilatorio extends X_EXME_ApoyoVentilatorio {
	...
	public MEXMEApoyoVentilatorio(Properties ctx, int EXME_ApoyoVentilatorio_ID, String trxName) {
		super(ctx, EXME_ApoyoVentilatorio_ID, trxName);
	}

	public MEXMEApoyoVentilatorio(Properties ctx, ResultSet rs, String trxName) {
	...
	public static List<KeyNamePair> get(Properties ctx, String trxName) {
		...
		try {
			sql.append("SELECT EXME_ApoyoVentilatorio_ID, Name ");
			sql.append(" FROM EXME_ApoyoVentilatorio ");
