...
public class EntityTypeRegister extends SvrProcess
{
		...
		throws Exception
	{
		...
		if (et.isSystemMaintained())
			throw new CompiereUserError("You cannot register a System maintained entity");
		
		throw new CompiereSystemError("To register an Entity Type, contact ComPiere directly");
