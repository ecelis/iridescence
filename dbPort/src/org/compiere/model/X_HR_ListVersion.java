...
public class X_HR_ListVersion extends PO implements I_HR_ListVersion, I_Persistent 
{
	...
	public org.compiere.model.I_HR_List getHR_List() throws RuntimeException 
    {
        Class<?> clazz = MTable.getClass(org.compiere.model.I_HR_List.Table_Name);
        org.compiere.model.I_HR_List result = null;
        try	{
	        Constructor<?> constructor = null;
	    	constructor = clazz.getDeclaredConstructor(new Class[]{Properties.class, int.class, String.class});
    	    result = (org.compiere.model.I_HR_List)constructor.newInstance(new Object[] {getCtx(), new Integer(getHR_List_ID()), get_TrxName()});
        } catch (Exception e) {
