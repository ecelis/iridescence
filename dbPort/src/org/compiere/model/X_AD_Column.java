...
// Y
	...
	/** Set Mask definitions.
		@param DefinitionMask 
		Customize a mask by defining a an specific character. E.g. x=[0123] for "m9" Format Mask. x - Represents a numeric character (0-3) Please use ';' or ',' to separate each mask definition. E.g. x=[0123] ; y=[A-Z] 
	  */
	public void setDefinitionMask (String DefinitionMask)
	{
		set_Value (COLUMNNAME_DefinitionMask, DefinitionMask);
	}

	/** Get Mask definitions.
		@return Customize a mask by defining a an specific character. E.g. x=[0123] for "m9" Format Mask. x - Represents a numeric character (0-3) Please use ';' or ',' to separate each mask definition. E.g. x=[0123] ; y=[A-Z] 
	  */
	public String getDefinitionMask () 
	{
		return (String)get_Value(COLUMNNAME_DefinitionMask);
	}
	...
	/** Set Is Search Column.
		@param IsSearchColumn Is Search Column	  */
	public void setIsSearchColumn (boolean IsSearchColumn)
	{
		set_Value (COLUMNNAME_IsSearchColumn, Boolean.valueOf(IsSearchColumn));
	}

	/** Get Is Search Column.
		@return Is Search Column	  */
	public boolean isSearchColumn () 
	{
		Object oo = get_Value(COLUMNNAME_IsSearchColumn);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	{
		set_Value (COLUMNNAME_ReplaceMaskChars, ReplaceMaskChars);
	}

	/** Get Replace mask characters.
		@return Define which characters of the mask are going to be replaced before saving, otherwise the value will be saved as is shown.
	  */
	public String getReplaceMaskChars () 
	{
		return (String)get_Value(COLUMNNAME_ReplaceMaskChars);
	}
