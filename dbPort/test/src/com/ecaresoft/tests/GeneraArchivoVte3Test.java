...
import org.compiere.process.GeneraArchivoVte3;
 ...
 *
 */
public class GeneraArchivoVte3Test extends TestCase {
	...
	public void testTestPacientesMedida() {
		...
		int num = GeneraArchivoVte3.testPacientesMedida( version,  optionRegistry,  ctx,  trxName,  file,  files);
		assertTrue(num ==1);
	}
	...
	public void testNumerador() {
		int count = GeneraArchivoVte3.testPacientesMedida(true);
		assertTrue(count >= 0);
	}
	...
	public void testDenominador() {
		int count = GeneraArchivoVte3.testPacientesMedida(false);
		assertTrue(count >= 0);
	}
}
