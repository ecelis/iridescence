...
public class X_C_TaxDefinition extends PO implements I_C_TaxDefinition, I_Persistent 
{
	...
	public org.compiere.model.I_C_TaxBase getC_TaxBase() throws RuntimeException 
    {
        Class<?> clazz = MTable.getClass(org.compiere.model.I_C_TaxBase.Table_Name);
        org.compiere.model.I_C_TaxBase result = null;
        try	{
	        Constructor<?> constructor = null;
	    	constructor = clazz.getDeclaredConstructor(new Class[]{Properties.class, int.class, String.class});
    	    result = (org.compiere.model.I_C_TaxBase)constructor.newInstance(new Object[] {getCtx(), new Integer(getC_TaxBase_ID()), get_TrxName()});
        } catch (Exception e) {
	        log.log(Level.SEVERE, "(id) - Table=" + Table_Name + ",Class=" + clazz, e);
	        log.saveError("Error", "Table=" + Table_Name + ",Class=" + clazz);
           throw new RuntimeException( e );
	...
	public org.compiere.model.I_C_TaxGroup getC_TaxGroup() throws RuntimeException 
    {
        Class<?> clazz = MTable.getClass(org.compiere.model.I_C_TaxGroup.Table_Name);
        org.compiere.model.I_C_TaxGroup result = null;
        try	{
	        Constructor<?> constructor = null;
	    	constructor = clazz.getDeclaredConstructor(new Class[]{Properties.class, int.class, String.class});
    	    result = (org.compiere.model.I_C_TaxGroup)constructor.newInstance(new Object[] {getCtx(), new Integer(getC_TaxGroup_ID()), get_TrxName()});
        } catch (Exception e) {
	        log.log(Level.SEVERE, "(id) - Table=" + Table_Name + ",Class=" + clazz, e);
	        log.saveError("Error", "Table=" + Table_Name + ",Class=" + clazz);
           throw new RuntimeException( e );
	...
	public org.compiere.model.I_C_TaxType getC_TaxType() throws RuntimeException 
    {
        Class<?> clazz = MTable.getClass(org.compiere.model.I_C_TaxType.Table_Name);
        org.compiere.model.I_C_TaxType result = null;
        try	{
	        Constructor<?> constructor = null;
	    	constructor = clazz.getDeclaredConstructor(new Class[]{Properties.class, int.class, String.class});
    	    result = (org.compiere.model.I_C_TaxType)constructor.newInstance(new Object[] {getCtx(), new Integer(getC_TaxType_ID()), get_TrxName()});
        } catch (Exception e) {
	        log.log(Level.SEVERE, "(id) - Table=" + Table_Name + ",Class=" + clazz, e);
	        log.saveError("Error", "Table=" + Table_Name + ",Class=" + clazz);
           throw new RuntimeException( e );
